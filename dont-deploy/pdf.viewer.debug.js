            ...
            var PDFSidebar = function PDFSidebarClosure() {
                ...
                PDFSidebar.prototype = {
                    ...
                    _showUINotification: function (view) {
                        ...
                        this.toggleButton.title = 'Toggle Sidebar (document contains outline/attachments)';
                        if (!this.isOpen) {
            ...
            var PDFThumbnailView = function PDFThumbnailViewClosure() {
                ...
                PDFThumbnailView.prototype = {
                    ...
                    _convertCanvasToImage: function PDFThumbnailView_convertCanvasToImage() {
                        ...
                        var ariaLabel = 'Thumbnail of Page {{page}}';
                ...
                SecondaryToolbar.prototype = {
                    ...
                    _bindHandToolListener: function SecondaryToolbar_bindHandToolListener(toggleHandToolButton) {
                        ...
                        this.eventBus.on('handtoolchanged', function (e) {
                            ...
                            if (isHandToolActive) {
                                toggleHandToolButton.title = 'Disable hand tool';
                                toggleHandToolButton.firstElementChild.textContent = 'Disable hand tool';
                            } else {
                                toggleHandToolButton.title = 'Enable hand tool';
                                toggleHandToolButton.firstElementChild.textContent = 'Enable hand tool';
                            }
                        });
                    },

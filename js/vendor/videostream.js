 ...
 * $Id: videostream.js,v 2.8.0 2018/10/02 21:52:46 dc Exp $
 */
...
VideoFile.prototype.fetcher = function(t, r, s) {
  return new MegaPromise(function(i, e) {
...
Streamer.prototype.getImage = function(c, f) {
  var u = this, l = this.video;
  return new Promise(function _(e, t) {
    if (!l.videoWidth) return t(-9);
    var i = u.dim(l.videoWidth, l.videoHeight, c || 1280, f || 720);
...
MP4Remuxer.prototype._processMoov = function(e) {
  ...
  for (var n = 0; n < s.length; n++) {
    var a, i, o = s[n], m = o.mdia.minf.stbl, f = m.stco || m.co64, u = m.stsd.entries[0], c = o.mdia.hdlr.handlerType;
    d && console.debug("handler=%s, type=%s, trak:", c, u.type, o);
    if (t._hasVideo || "vide" !== c || "avc1" !== u.type) {
      if (t._hasAudio || "soun" !== c) continue;
      if ("mp4a" === u.type) {
        a = "mp4a";
        u.esds && u.esds.mimeCodec && (a += "." + u.esds.mimeCodec);
        r[a] && (a = "mp3");
      } else a = "fLaC" === u.type ? "flac" : u.type;
      i = (i = 'audio/mp4; codecs="%"').replace("%", a);
      d && console.debug(i);
      if (!MediaSource.isTypeSupported(i) && ("mp3" !== a || !MediaSource.isTypeSupported(i = "audio/mpeg"))) {
      ...
      a = "avc1";
      u.avcC && (a += "." + u.avcC.mimeCodec);
      i = 'video/mp4; codecs="' + a + '"';
      d && console.debug(i);
      t._hasVideo = a;
    }
    ...
    } else console.warn("No 'stts' entries for trak %s...", n, o);
  }
  if (0 !== t._tracks.length) {
    ...
    var O = Box.encode(t._ftyp), z = t._tracks.map(function(e) {
      var t = Box.encode(e.moov);
      return {
        mime: e.mime,
        init: Buffer.concat([ O, t ])
      };
    });
    t.emit("ready", z);

 ...
 * $Id: videostream.js,v 3.2.0 2018/10/17 18:26:11 dc Exp $
 */
...
function AudioStream(t, e, i) {
  ...
  EventEmitter.call(a);
  var r = new AudioContext(), o = function(t) {
    log(t);
    a.destroy(t);
  };
  a._buffer = null;
  ...
  s.on("end", tryCatch(function() {
    s.destroy();
    s._file.reset();
    var t = toArrayBuffer(a._buffer);
    a._buffer = null;
    a.emit("audio-buffer", t);
    r.decodeAudioData(t).then(a._setup.bind(a, i.autoplay)).catch(o);
  }, o));
...
AudioStream.prototype._setup = function(t, e) {
  var i = this, a = i._elem, r = i._audioContext, o = r.createMediaStreamDestination(), s = document.createElement("canvas"), n = s.captureStream(30), u = [ o.stream.getTracks()[0], n.getTracks()[0] ], h = r.createAnalyser();
...
AudioVisualiser.prototype._draw = function() {
  var e = this, i = ++e._tick, t = e._stream, a = t._videoContext, r = t._audioAnalyser, o = $(t._elem).parent();
  a.width = o.outerWidth() + 16 & -16;
  a.height = o.outerHeight() + 16 & -16;
  var s = a.getContext("2d");
  e.init(s, a.width, a.height, a);
...
Visualiser.prototype.init = function(t, e, i, a) {
  ...
  while (u-- > 0) {
    ...
    s = (Math.random() - .5) * i;
    n = 3 * (Math.random() + .1);
    h.push(new Star(o, s, n, t, e, i, this));
  }
  this.stars = h;
};

Visualiser.prototype.draw = function(t, e, i, a, r) {
  var o, s, n, u, h, l = 0, d = t.byteLength;
  for (n = 0; n < 80; n++) l += t[n];
  o = (this.volume = l) / 1e3;
  h = u = n = 31 + (Math.sin(o) + 1);
  e.clearRect(0, 0, i, a);
  e.beginPath();
  e.rect(0, 0, i, a);
  (s = e.createRadialGradient(i / 2, a / 2, o / 1.4, i / 2, a / 2, i - Math.min(Math.pow(o / 1.4, 2.7), i - 20))).addColorStop(0, "rgba(0,0,0,0)");
  s.addColorStop(.8, "rgba(" + Math.round(n) + ", " + Math.round(u) + ", " + Math.round(h) + ", 0.4)");
  e.fillStyle = s;
  e.fill();
  e.closePath();
  e.beginPath();
  e.fillStyle = this.gradient;
  while (d--) e.fillRect(5 * d, (a - (o = t[d] / 1.4)) / 1.2, 4, o / 1.3);
  e.closePath();
...
Star.prototype.drawStar = function() {
  ...
  this.ctx.stroke();
  this.ctx.closePath();
  var o = i / 20 * this.starSize;
  this.high -= Math.max(this.high - 1e-4, 0);
  o > this.high && (this.high = o);
  var s = Math.cos(this.angle) * this.high, n = Math.sin(this.angle) * this.high;
  this.x += this.x > 0 ? s : -s;
  this.y += this.y > 0 ? n : -n;
...
},{"/bundle/utils":3,"buffer":8,"eventemitter3":13,"to-arraybuffer":74}],2:[function(require,module,exports){
"use strict";
...
VideoFile.prototype.onIdle = function(e) {
...
VideoFile.prototype.fetcher = function(t, r, s) {
  return SIMULATE_RESUME_FROM_STALLED && r > 8 * REQUEST_SIZE ? MegaPromise.reject({
    target: {
      status: 509
    }
  }, t) : new MegaPromise(function(i, e) {
    M.gfsfetch(t, r, s).fail(e).done(function(e) {
      var t = e.buffer;
      delete e.buffer;
      i([ e, t ]);
    });
 ...
 */ function Streamer(e, t, i) {
  ...
  void 0 === this.options.type ? this.initTypeGuess(e) : this.init(e);
  d && (window.strm = this);
}
...
Streamer.prototype.initTypeGuess = function(s) {
  var a = this, t = new VideoFile(s, a), o = function(e) {
    t.destroy();
    a.init(e);
  };
  t.fetcher(s, 0, 16).then(function(e) {
    var t = e.buffer;
    delete e.buffer;
    if (Array.isArray(e)) {
      t = e[1];
    ...
    var i = new DataView(t), r = i.getUint32(0, !1);
    440786851 === r ? a.options.type = "WebM" : r >> 8 === 4801587 ? a.options.type = "MPEG Audio" : 1332176723 === r ? a.options.type = "Ogg" : 1716281667 === r ? a.options.type = "FLAC" : 1295270176 === i.getUint32(8, !1) ? a.options.type = "M4A " : 1463899717 === i.getUint32(8, !1) && (a.options.type = "Wave");
    o("string" === typeof s ? e : s);
  }).catch(function(e) {
...
Streamer.prototype.onPlayBackEvent = function(e) {
  ...
  if (e) {
    ...
    if (this.stalled) {
      ...
      this.msie && (this.video.currentTime = this.video.currentTime - .2);
    }
  }
};
  ...
  switch (e.type) {
   ...
   case "timeupdate":
    ...
    if (this.timeupdate !== t.currentTime) {
      ...
      this.stalled && t.readyState > 2 && this.onPlayBackEvent(!0);
      i.paused || this._setActivityTimer();
    }
  }
  if (this.evs[e.type]) {
    var r;
    if ("error" === e.type) {
      var s = t.error || !1, a = Object(this.stream._elemWrapper).detailedError;
      r = a && a.message || s.message;
...
Streamer.prototype.play = function() {
  ...
  if (i.bgtask) {
    ...
    i.overquota || i.flushRetryQueue();
    this.options.autoplay = !0;
  }
  i && this._setActivityTimer();
};
...
Streamer.prototype.notify = function(e) {
  ...
  if (this.evs[t]) {
    ...
    var s = this.evs[t].filter(function(e) {
...
Streamer.prototype._setActivityTimer = function() {
  ...
  this.activitimer = setTimeout(function() {
    var e = t.video || !1;
    if (!e.paused && !e.ended || !t.file.bgtask && t.isOverQuota) {
      t.stalled = !0;
      t.notify("inactivity");
      t.handleEvent({
        type: "stalled",
...
Streamer.prototype.getImage = function(c, l) {
  var u = this, f = this.video;
  return new Promise(function _(e, t) {
    if (f.videoWidth) {
      var i = u.dim(f.videoWidth, f.videoHeight, c || 1280, l || 720);
      d && console.debug("[Streamer.getImage()] Taking %sx%s image from %sx%s at %s", i.width, i.height, f.videoWidth, f.videoHeight, secondsToTime(f.currentTime));
      var r = document.createElement("canvas"), s = r.getContext("2d");
      r.width = Math.round(i.width);
      r.height = Math.round(i.height);
      s.drawImage(f, 0, 0, r.width, r.height);
      ...
      if (Math.round(100 * h / n) > 70) {
        ...
        f.paused || f.ended ? onIdle(function() {
          t(-5);
        }) : setTimeout(_.bind(this, e, t), 800);
...
Streamer.prototype.getProperty = function(e) {
  var t = this.file || !1;
  switch (e) {
   case "server":
    var i = t.data, r = i && i.g;
    return r && String(r).split("//").pop().split(".")[0] || !1;

   case "bitrate":
    return t.filesize / this.duration || !1;
  }
  return !1;
};
...
Object.defineProperty(Streamer.prototype, "currentTime", {
  ...
  set: function(e) {
    ...
    if (i instanceof AudioStream) {
      i._stop();
      i._play(e);
      this.play();
    } else t.readyState && (t.currentTime = e + this.presentationOffset);
...
Object.defineProperty(Streamer.prototype, "goAudioStream", {
  get: function() {
    ...
    return "M4A " === e ? mega.fullAudioContextSupport : "MPEG Audio" === e || "Wave" === e || "Ogg" === e || "FLAC" === e;
  }
});
...
Object.defineProperty(Streamer.prototype, "isOverQuota", {
  get: function() {
    var e = this.file || !1;
    return e.overquota && !Object.keys(e.fetching || {}).length;
  }
});
...
},{"../audiostream":1,"../videostream":77,"/bundle/utils":3,"buffer":8,"readable-stream":72}],3:[function(require,module,exports){
...
},{"/bundle/utils":3,"buffer":8,"ebml/lib/ebml/decoder":9,"eventemitter3":13,"readable-stream":72}],5:[function(require,module,exports){
  ...
  if (e) {
    ...
    try {
      if (r) for (var s = e.traks.length; s--; ) {
        var n = e.traks[s];
        if (n.tkhd.trackId === r.referenceId) {
          n.sidx = r;
          break;
        }
      }
...
MP4Remuxer.prototype._findMoov = function(e) {
  ...
  s._decoder.once("box", function(t) {
    var r = function() {
      i.destroy();
      s._decoder.destroy();
      s["_" + a] ? s._parseMoov() : s._findMoov(e + t.length);
    };
    d && console.debug("box", t.type, t.length, t, e);
    n[t.type] ? s._decoder.decode(function(e) {
      s["_" + t.type] = e;
      r();
    }) : r();
  });
...
MP4Remuxer.prototype._processMoov = function(e) {
  ...
  if (e.otherBoxes) for (var n = e.otherBoxes.length; n--; ) if (e.otherBoxes[n] instanceof Error) {
    t.emit("error", e.otherBoxes[n]);
    return;
  }
  t._tracks = [];
  t._hasVideo = !1;
  ...
  for (var a = 0; a < s.length; a++) {
    var i, o, f = s[a], m = f.mdia.minf.stbl, u = m.stco || m.co64, c = m.stsd.entries[0], l = f.mdia.hdlr.handlerType;
    d && console.debug("handler=%s, type=%s, trak:", l, c.type, f);
    if (t._hasVideo || "vide" !== l || "avc1" !== c.type) {
      if (t._hasAudio || "soun" !== l) continue;
      if ("mp4a" === c.type) {
        i = "mp4a";
        c.esds && c.esds.mimeCodec && (i += "." + c.esds.mimeCodec);
        r[i] && (i = "mp3");
      } else i = "fLaC" === c.type ? "flac" : c.type;
      o = (o = 'audio/mp4; codecs="%"').replace("%", i);
      d && console.debug(o);
      if (!MediaSource.isTypeSupported(o) && ("mp3" !== i || !MediaSource.isTypeSupported(o = "audio/mpeg"))) {
        t._hasUnsupportedAudio = i;
        continue;
      }
      t._hasAudio = i;
    } else {
      i = "avc1";
      c.avcC && (i += "." + c.avcC.mimeCodec);
      o = 'video/mp4; codecs="' + i + '"';
      d && console.debug(o);
      t._hasVideo = i;
    }
    var p, h = [], v = 0, _ = 0, g = 0, y = 0, x = 0, S = 0, k = new RunLengthIndex(m.stts.entries), M = null;
    m.ctts && (M = new RunLengthIndex(m.ctts.entries));
    var b = 0;
    if (k.value) {
      while (1) {
        p = m.stsc.entries[x];
        var B = m.stsz.entries[v], I = k.value && k.value.duration || 0, R = !0;
        m.stss && (R = m.stss.entries[b] === v + 1);
        h.push({
          size: B,
          duration: I,
          dts: S,
          presentationOffset: M && M.value.compositionOffset || 0,
          sync: R,
          offset: y + u.entries[g]
        });
        if (++v >= m.stsz.entries.length) break;
        y += B;
        if (++_ >= p.samplesPerChunk) {
          y = _ = 0;
          g++;
          var E = m.stsc.entries[x + 1];
          E && g + 1 >= E.firstChunk && x++;
        }
        S += I;
        k.inc();
        M && M.inc();
      ...
      f.mdia.mdhd.duration = 0;
      f.tkhd.duration = 0;
      var w = p && p.sampleDescriptionId || 0, O = {
        type: "moov",
        mvhd: e.mvhd,
        traks: [ {
          tkhd: f.tkhd,
          mdia: {
            ...
            elng: f.mdia.elng,
            minf: {
              vmhd: f.mdia.minf.vmhd,
              smhd: f.mdia.minf.smhd,
              dinf: f.mdia.minf.dinf,
              stbl: {
                stsd: m.stsd,
                stts: empty(),
                ctts: empty(),
      ...
      t._tracks.push({
        fragmentSequence: 1,
        trackId: f.tkhd.trackId,
        timeScale: f.mdia.mdhd.timeScale,
        samples: h,
        currSample: null,
        currTime: null,
        moov: O,
    ...
    } else console.warn("No 'stts' entries for trak %s...", a, f);
  }
  if (0 !== t._tracks.length) {
    ...
    var z = Box.encode(t._ftyp), T = t._tracks.map(function(e) {
...
MP4Remuxer.prototype._writeFragment = function(r, e) {
  var s = this, t = s._tracks[e], n = t.inStream, a = t.outStream, i = function(t) {
    return function(e) {
      e ? s.emit("error", e) : a.destroyed || n.destroyed ? d > 1 && console.debug("writeFragment stream destroyed", a.destroyed, n.destroyed) : t();
    };
  }, o = i(function() {
    if (!(r = s._generateFragment(e))) return a.finalize();
    m();
  }), f = i(function() {
    var e = n.slice(r.ranges), t = a.mediaData(r.length, o);
    e.pipe(t);
  }), m = function() {
    a.destroyed || a.box(r.moof, f);
  };
  m();
};
...
MP4Remuxer.prototype.seek = function(s) {
  var n = this;
  if (!n._tracks) throw new Error("Not ready yet; wait for 'ready' event");
  if (n._fileStream) {
    n._fileStream.destroy();
    n._fileStream = null;
  }
  var a = 0, i = Math.pow(2, 53);
  n._tracks.forEach(function(e, t) {
    e.fragment = n._generateFragment(t, s);
    if (e.fragment) {
  ...
  if (d) {
    console.debug("MP4Remuxer: Measured highWaterMark to need %s bytes.", a);
    a > 1e7 && console.warn("^ excessive highWaterMark detected...");
  }
  a = a + 16777216 & -16777216;
  return n._tracks.map(function(e, t) {
    e.outStream && e.outStream.destroy();
    if (e.inStream) {
      e.inStream.destroy();
      e.inStream = null;
    ...
    if (e.fragment) {
      ...
      n._fileStream || (n._fileStream = n._file.createReadStream({
        start: i
      }));
      n._fileStream.pipe(e.inStream);
      n._writeFragment(e.fragment, t);
...
MP4Remuxer.prototype._findSampleBefore = function(e, t) {
  var r = this._tracks[e], s = Math.floor(r.timeScale * t), n = bs(r.samples, s, function(e, t) {
    return e.dts + e.presentationOffset - t;
  });
  -1 === n ? n = 0 : n < 0 && (n = -n - 2);
  if (n < 1) return 0;
  var a = n;
  while (!r.samples[n].sync) if (--n < 0) return a;
  return n;
};
...
MP4Remuxer.prototype._generateFragment = function(e, t) {
  ...
  for (var n = s.samples[r].dts, a = 0, i = [], o = r; o < s.samples.length; o++) {
    var d = s.samples[o];
    if (d.sync && d.dts - n >= s.timeScale * MIN_FRAGMENT_DURATION) break;
    a += d.size;
    var f = i.length - 1;
    f < 0 || i[f].end !== d.offset ? i.push({
      start: d.offset,
      end: d.offset + d.size
    }) : i[f].end += d.size;
  }
...
MP4Remuxer.prototype._generateMoof = function(e, t, r) {
  for (var s = this._tracks[e], n = [], a = 0, i = t; i < r; i++) {
    var o = s.samples[i];
    o.presentationOffset < 0 && (a = 1);
    n.push({
      sampleDuration: o.duration,
      sampleSize: o.size,
      sampleFlags: o.sync ? 33554432 : 16842752,
      sampleCompositionTimeOffset: o.presentationOffset
    });
  }
  var d = {
    type: "moof",
    mfhd: {
      sequenceNumber: s.fragmentSequence++
    },
    trafs: [ {
      tfhd: {
        flags: 131072,
  ...
  d.trafs[0].trun.dataOffset += Box.encodingLength(d);
  return d;
};
...
Box.boxes.co64.decode = function(e, t) {
  for (var r = (e = e.slice(t)).readUInt32BE(0), s = new Array(r), n = 0; n < r; n++) {
    var a = 8 * n + 4, i = e.readUInt32BE(a), o = e.readUInt32BE(a + 4);
    s[n] = i * UINT32_MAX + o;
  }
  return {
    entries: s
...
Box.boxes.sidx.decode = function(t, e) {
  var r, s = Object.create(null), n = e + 4, a = function() {
    var e = t.readUInt16BE(n);
    n += 2;
    return e;
  }, i = function() {
    var e = t.readUInt32BE(n);
    n += 4;
    return e;
  }, o = function() {
    var e = i(), t = i();
  ...
  for (var d = 0; d < s.count; d++) {
    var f = s.entries[d] = Object.create(null), m = i();
    f.type = m >>> 31 & 1;
    f.size = 2147483647 & m;
    f.duration = i();
    m = i();
    f.sap = m >>> 31 & 1;
    f.sapType = m >>> 28 & 7;
    f.sapDelta = 268435455 & m;
    f.byteOffset = [ e, e + f.size - 1 ];
    f.timeOffset = [ r, r / s.timescale, f.duration / s.timescale ];
    e += f.size;
    r += f.duration;
  }
  return s;
};
},{"/bundle/utils":3,"binary-search":7,"buffer":8,"eventemitter3":13,"mp4-box-encoding":30,"mp4-stream":33,"range-slice-stream":49}],6:[function(require,module,exports){
"use strict";
...
function Buffer(e, r, t) {
  if ("number" !== typeof e) return from(e, r, t);
...
function from(e, r, t) {
  ...
  if (null != n && n !== e) return Buffer.from(n, r, t);
  var f = fromObject(e);
  if (f) return f;
...
function alloc(e, r, t) {
  return e <= 0 ? createBuffer(e) : void 0 !== r ? "string" === typeof t ? createBuffer(e).fill(r, t) : createBuffer(e).fill(r) : createBuffer(e);
}
...
function fromString(e, r) {
  ...
  if (!Buffer.isEncoding(r)) throw new TypeError("Unknown encoding: " + r);
  var t = 0 | byteLength(e, r), n = createBuffer(t), f = n.write(e, r);
  f !== t && (n = n.slice(0, f));
  return n;
}

function fromArrayLike(e) {
  for (var r = e.length < 0 ? 0 : 0 | e.length, t = createBuffer(r), n = 0; n < r; n += 1) t[n] = 255 & e[n];
  return t;
}
...
function fromArrayBuffer(e, r, t) {
  ...
  var n;
  (n = void 0 === r && void 0 === t ? new Uint8Array(e) : void 0 === t ? new Uint8Array(e, r) : new Uint8Array(e, r, t)).__proto__ = Buffer.prototype;
  return n;
}

function fromObject(e) {
  if (Buffer.isBuffer(e)) {
    var r = 0 | e.length, t = createBuffer(r);
...
Buffer.compare = function(e, r) {
  ...
  if (!Buffer.isBuffer(e) || !Buffer.isBuffer(r)) throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
  if (e === r) return 0;
  for (var t = e.length, n = r.length, f = 0, i = Math.min(t, n); f < i; ++f) if (e[f] !== r[f]) {
    t = e[f];
    n = r[f];
    break;
  }
...
Buffer.concat = function(e, r) {
  ...
  var t;
  if (void 0 === r) for (t = r = 0; t < e.length; ++t) r += e[t].length;
...
function byteLength(e, r) {
  ...
  var t = e.length, n = arguments.length > 2 && !0 === arguments[2];
  if (!n && 0 === t) return 0;
...
Buffer.prototype.inspect = function() {
  var e = "", r = exports.INSPECT_MAX_BYTES;
  e = this.toString("hex", 0, r).replace(/(.{2})/g, "$1 ").trim();
  this.length > r && (e += " ... ");
  return "<Buffer " + e + ">";
};

Buffer.prototype.compare = function(e, r, t, n, f) {
  isInstance(e, Uint8Array) && (e = Buffer.from(e, e.offset, e.byteLength));
  if (!Buffer.isBuffer(e)) throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof e);
  void 0 === r && (r = 0);
  void 0 === t && (t = e ? e.length : 0);
  void 0 === n && (n = 0);
  void 0 === f && (f = this.length);
  if (r < 0 || t > e.length || n < 0 || f > this.length) throw new RangeError("out of range index");
  if (n >= f && r >= t) return 0;
  if (n >= f) return -1;
  if (r >= t) return 1;
  if (this === e) return 0;
  for (var i = (f >>>= 0) - (n >>>= 0), o = (t >>>= 0) - (r >>>= 0), u = Math.min(i, o), s = this.slice(n, f), a = e.slice(r, t), h = 0; h < u; ++h) if (s[h] !== a[h]) {
    i = s[h];
    o = a[h];
    break;
  }
...
function bidirectionalIndexOf(e, r, t, n, f) {
  if (0 === e.length) return -1;
  if ("string" === typeof t) {
    n = t;
    t = 0;
  } else t > 2147483647 ? t = 2147483647 : t < -2147483648 && (t = -2147483648);
  numberIsNaN(t = +t) && (t = f ? 0 : e.length - 1);
  t < 0 && (t = e.length + t);
  if (t >= e.length) {
    if (f) return -1;
    t = e.length - 1;
  ...
  if (Buffer.isBuffer(r)) return 0 === r.length ? -1 : arrayIndexOf(e, r, t, n, f);
  if ("number" !== typeof r) throw new TypeError("val must be string, number or Buffer");
  r &= 255;
  return "function" === typeof Uint8Array.prototype.indexOf ? f ? Uint8Array.prototype.indexOf.call(e, r, t) : Uint8Array.prototype.lastIndexOf.call(e, r, t) : arrayIndexOf(e, [ r ], t, n, f);
}

function arrayIndexOf(e, r, t, n, f) {
  var i, o = 1, u = e.length, s = r.length;
  ...
  if (f) {
    var a = -1;
    for (i = t; i < u; i++) if (read(e, i) === read(r, -1 === a ? 0 : i - a)) {
      -1 === a && (a = i);
    ...
    t + s > u && (t = u - s);
    for (i = t; i >= 0; i--) {
      for (var h = !0, c = 0; c < s; c++) if (read(e, i + c) !== read(r, c)) {
        h = !1;
        break;
      }
      if (h) return i;
...
function utf8Write(e, r, t, n) {
  return blitBuffer(utf8ToBytes(r, e.length - t), e, t, n);
}

function asciiWrite(e, r, t, n) {
  return blitBuffer(asciiToBytes(r), e, t, n);
}

function latin1Write(e, r, t, n) {
  return asciiWrite(e, r, t, n);
}

function base64Write(e, r, t, n) {
  return blitBuffer(base64ToBytes(r), e, t, n);
}

function ucs2Write(e, r, t, n) {
  return blitBuffer(utf16leToBytes(r, e.length - t), e, t, n);
}

Buffer.prototype.write = function(e, r, t, n) {
  if (void 0 === r) {
    n = "utf8";
    t = this.length;
    r = 0;
  ...
  var f = this.length - r;
  (void 0 === t || t > f) && (t = f);
  if (e.length > 0 && (t < 0 || r < 0) || r > this.length) throw new RangeError("Attempt to write outside buffer bounds");
  n || (n = "utf8");
...
function base64Slice(e, r, t) {
  return base64.fromByteArray(0 === r && t === e.length ? e : e.slice(r, t));
}
...
function decodeCodePointsArray(e) {
  ...
  var t = "", n = 0;
  while (n < r) t += String.fromCharCode.apply(String, e.slice(n, n += MAX_ARGUMENTS_LENGTH));
  return t;
}
...
function asciiSlice(e, r, t) {
  var n = "";
  t = Math.min(e.length, t);
  for (var f = r; f < t; ++f) n += String.fromCharCode(127 & e[f]);
  return n;
}
...
function latin1Slice(e, r, t) {
  var n = "";
  t = Math.min(e.length, t);
  for (var f = r; f < t; ++f) n += String.fromCharCode(e[f]);
  return n;
}
...
function hexSlice(e, r, t) {
  ...
  (!r || r < 0) && (r = 0);
  (!t || t < 0 || t > n) && (t = n);
  for (var f = "", i = r; i < t; ++i) f += toHex(e[i]);
  return f;
}

function utf16leSlice(e, r, t) {
  for (var n = e.slice(r, t), f = "", i = 0; i < n.length; i += 2) f += String.fromCharCode(n[i] + 256 * n[i + 1]);
  return f;
}
...
Buffer.prototype.slice = function(e, r) {
  ...
  (r = void 0 === r ? t : ~~r) < 0 ? (r += t) < 0 && (r = 0) : r > t && (r = t);
  r < e && (r = e);
...
Buffer.prototype.readUIntLE = function(e, r, t) {
  r >>>= 0;
  var n = this[e >>>= 0], f = 1, i = 0;
  while (++i < r && (f *= 256)) n += this[e + i] * f;
  return n;
};

Buffer.prototype.readUIntBE = function(e, r, t) {
  r >>>= 0;
  var n = this[(e >>>= 0) + --r], f = 1;
  while (r > 0 && (f *= 256)) n += this[e + --r] * f;
  return n;
};
...
Buffer.prototype.readUInt16LE = function(e, r) {
  return this[e >>>= 0] | this[e + 1] << 8;
};

Buffer.prototype.readUInt16BE = function(e, r) {
  return this[e >>>= 0] << 8 | this[e + 1];
};

Buffer.prototype.readUInt32LE = function(e, r) {
  return (this[e >>>= 0] | this[e + 1] << 8 | this[e + 2] << 16) + 16777216 * this[e + 3];
};

Buffer.prototype.readUInt32BE = function(e, r) {
  return 16777216 * this[e >>>= 0] + (this[e + 1] << 16 | this[e + 2] << 8 | this[e + 3]);
};
...
Buffer.prototype.readIntLE = function(e, r, t) {
  ...
  var n = this[e >>>= 0], f = 1, i = 0;
  while (++i < r && (f *= 256)) n += this[e + i] * f;
  n >= (f *= 128) && (n -= Math.pow(2, 8 * r));
  return n;
};

Buffer.prototype.readIntBE = function(e, r, t) {
  var n = r >>>= 0, f = 1, i = this[(e >>>= 0) + --n];
  while (n > 0 && (f *= 256)) i += this[e + --n] * f;
  i >= (f *= 128) && (i -= Math.pow(2, 8 * r));
  return i;
};

Buffer.prototype.readInt8 = function(e, r) {
  return 128 & this[e >>>= 0] ? -1 * (255 - this[e] + 1) : this[e];
};

Buffer.prototype.readInt16LE = function(e, r) {
  var t = this[e >>>= 0] | this[e + 1] << 8;
  return 32768 & t ? 4294901760 | t : t;
};

Buffer.prototype.readInt16BE = function(e, r) {
  var t = this[1 + (e >>>= 0)] | this[e] << 8;
  return 32768 & t ? 4294901760 | t : t;
};

Buffer.prototype.readInt32LE = function(e, r) {
  return this[e >>>= 0] | this[e + 1] << 8 | this[e + 2] << 16 | this[e + 3] << 24;
};

Buffer.prototype.readInt32BE = function(e, r) {
  return this[e >>>= 0] << 24 | this[e + 1] << 16 | this[e + 2] << 8 | this[e + 3];
};

Buffer.prototype.readFloatLE = function(e, r) {
  return ieee754.read(this, e >>>= 0, !0, 23, 4);
};

Buffer.prototype.readFloatBE = function(e, r) {
  return ieee754.read(this, e >>>= 0, !1, 23, 4);
};

Buffer.prototype.readDoubleLE = function(e, r) {
  return ieee754.read(this, e >>>= 0, !0, 52, 8);
};

Buffer.prototype.readDoubleBE = function(e, r) {
  return ieee754.read(this, e >>>= 0, !1, 52, 8);
};

Buffer.prototype.writeUIntLE = function(e, r, t, n) {
  t >>>= 0;
  var f = 1, i = 0;
  this[r >>>= 0] = 255 & (e = +e);
  while (++i < t && (f *= 256)) this[r + i] = e / f & 255;
  return r + t;
};

Buffer.prototype.writeUIntBE = function(e, r, t, n) {
  var f = (t >>>= 0) - 1, i = 1;
  this[(r >>>= 0) + f] = 255 & (e = +e);
  while (--f >= 0 && (i *= 256)) this[r + f] = e / i & 255;
  return r + t;
};
...
Buffer.prototype.writeIntLE = function(e, r, t, n) {
  var f = 0, i = 1, o = 0;
  this[r >>>= 0] = 255 & (e = +e);
  while (++f < t && (i *= 256)) {
    e < 0 && 0 === o && 0 !== this[r + f - 1] && (o = 1);
    this[r + f] = (e / i >> 0) - o & 255;
  }
  return r + t;
};

Buffer.prototype.writeIntBE = function(e, r, t, n) {
  var f = t - 1, i = 1, o = 0;
  this[(r >>>= 0) + f] = 255 & (e = +e);
  while (--f >= 0 && (i *= 256)) {
    e < 0 && 0 === o && 0 !== this[r + f + 1] && (o = 1);
...
function writeFloat(e, r, t, n, f) {
  ieee754.write(e, r = +r, t >>>= 0, n, 23, 4);
  return t + 4;
}
...
function writeDouble(e, r, t, n, f) {
  ieee754.write(e, r = +r, t >>>= 0, n, 52, 8);
  return t + 8;
}
...
Buffer.prototype.copy = function(e, r, t, n) {
  ...
  var f = n - t;
  if (this === e && "function" === typeof Uint8Array.prototype.copyWithin) this.copyWithin(r, t, n); else if (this === e && t < r && r < n) for (var i = f - 1; i >= 0; --i) e[i + r] = this[i + t]; else Uint8Array.prototype.set.call(e, this.subarray(t, n), r);
  return f;
};

Buffer.prototype.fill = function(e, r, t, n) {
  if ("string" === typeof e) {
    if ("string" === typeof r) {
      n = r;
      r = 0;
  ...
  e || (e = 0);
  var i;
  if ("number" === typeof e) for (i = r; i < t; ++i) this[i] = e; else {
    var o = Buffer.isBuffer(e) ? e : Buffer.from(e, n), u = o.length;
...
function utf8ToBytes(e, r) {
  r = r || Infinity;
  for (var t, n = e.length, f = null, i = [], o = 0; o < n; ++o) {
    ...
    } else f && (r -= 3) > -1 && i.push(239, 191, 189);
    f = null;
    if (t < 128) {
      if ((r -= 1) < 0) break;
      i.push(t);
...
function utf16leToBytes(e, r) {
  for (var t, n, f = [], i = 0; i < e.length; ++i) {
    if ((r -= 2) < 0) break;
...
function blitBuffer(e, r, t, n) {
  for (var f = 0; f < n; ++f) {
    if (f + t >= r.length || f >= e.length) break;
    r[f + t] = e[f];
  }
  return f;
}
...
},{"./schema.js":10,"./tools.js":11,"/bundle/utils":3,"buffer":8,"readable-stream":72}],10:[function(require,module,exports){
...
module.exports = eos;
},{"once":47}],13:[function(require,module,exports){
"use strict";
...
},{"/bundle/utils":3,"readable-stream":26,"to-arraybuffer":74}],16:[function(require,module,exports){
"use strict";

var codes = {};

function createErrorType(e, o, r) {
  r || (r = Error);
  var t = function(n) {
    require("/bundle/utils").inherit(NodeError, n);
    function NodeError(e, r, t) {
      return n.call(this, "string" === typeof o ? o : o(e, r, t)) || this;
    }
    return NodeError;
  }(r);
  t.prototype.name = r.name;
  codes[t.prototype.code = e] = t;
}
...
function oneOf(e, r) {
  if (Array.isArray(e)) {
    ...
    return t > 2 ? "one of " + r + " " + e.slice(0, t - 1).join(", ") + ", or " + e[t - 1] : 2 === t ? "one of " + r + " " + e[0] + " or " + e[1] : "of " + r + " " + e[0];
  }
  return "of " + r + " " + String(e);
}
...
function endsWith(e, r, t) {
  ...
  return e.substring(t - r.length, t) === r;
}

function includes(e, r, t) {
  "number" !== typeof t && (t = 0);
  return !(t + r.length > e.length) && -1 !== e.indexOf(r, t);
}
...
createErrorType("ERR_INVALID_ARG_TYPE", function(e, r, t) {
  var n;
  if ("string" === typeof r && startsWith(r, "not ")) {
    n = "must not be";
    r = r.replace(/^not /, "");
  } else n = "must be";
  return (endsWith(e, " argument") ? "The " + e + " " + n + " " + oneOf(r, "type") : 'The "' + e + '" ' + (includes(e, ".") ? "property" : "argument") + " " + n + " " + oneOf(r, "type")) + ". Received type " + typeof t;
}, TypeError);
...
},{"/bundle/utils":3}],17:[function(require,module,exports){
"use strict";
...
},{"./_stream_readable":19,"./_stream_writable":21,"/bundle/utils":3}],18:[function(require,module,exports){
"use strict";
...
},{"./_stream_transform":20,"/bundle/utils":3}],19:[function(require,module,exports){
"use strict";
...
function ReadableState(e, t, n) {
  ...
  "boolean" !== typeof n && (n = t instanceof Duplex);
  this.objectMode = !!(e = e || {}).objectMode;
  n && (this.objectMode = this.objectMode || !!e.readableObjectMode);
  this.highWaterMark = getHighWaterMark(this, e, "readableHighWaterMark", n);
...
function Readable(e) {
  ...
  this._readableState = new ReadableState(e, this, this instanceof Duplex);
  this.readable = !0;
  if (e) {
...
function readableAddChunk(e, t, n, r, i) {
  ...
  if (null === t) {
    ...
    if (d) e.emit("error", d); else if (a.objectMode || t && t.length > 0) {
      ...
      if (r) a.endEmitted ? e.emit("error", new ERR_STREAM_UNSHIFT_AFTER_END_EVENT()) : addChunk(e, a, t, !0); else if (a.ended) e.emit("error", new ERR_STREAM_PUSH_AFTER_EOF()); else {
...
function chunkInvalid(e, t) {
  var n;
  _isUint8Array(t) || "string" === typeof t || void 0 === t || e.objectMode || (n = new ERR_INVALID_ARG_TYPE("chunk", [ "string", "Buffer", "Uint8Array" ], t));
  return n;
}
...
function emitReadable(e) {
  ...
  if (!t.emittedReadable) {
    t.emittedReadable = !0;
    onIdleA(emitReadable_.bind(null, e));
  }
}
...
function maybeReadMore(e, t) {
  if (!t.readingMore) {
    t.readingMore = !0;
    onIdleA(maybeReadMore_.bind(null, e, t));
  }
}

function maybeReadMore_(e, t) {
  var n = t.length;
  while (!t.reading && !t.ended && t.length < t.highWaterMark) {
    e.read(0);
    if (n === t.length) break;
    n = t.length;
  }
...
Readable.prototype.pipe = function(n, e) {
  ...
  i.endEmitted ? onIdleA(t.bind(null)) : r.once("end", t);
  ...
  function ondata(e) {
    if (!1 === n.write(e)) {
      (1 === i.pipesCount && i.pipes === n || i.pipesCount > 1 && -1 !== indexOf(i.pipes, n)) && !d && i.awaitDrain++;
      r.pause();
    }
  }
  function onerror(e) {
...
Readable.prototype.on = function(e, t) {
  var n = Stream.prototype.on.call(this, e, t), r = this._readableState;
  if ("data" === e) {
    ...
    r.flowing = !1;
    r.emittedReadable = !1;
    r.length ? emitReadable(this) : r.reading || onIdleA(nReadingNextTick.bind(null, this));
  }
  return n;
};
...
Readable.prototype.removeListener = function(e, t) {
  var n = Stream.prototype.removeListener.call(this, e, t);
  "readable" === e && onIdleA(updateReadableListening.bind(null, this));
  return n;
};

Readable.prototype.removeAllListeners = function(e) {
  var t = Stream.prototype.removeAllListeners.apply(this, arguments);
  "readable" !== e && void 0 !== e || onIdleA(updateReadableListening.bind(null, this));
  return t;
};
...
function fromList(e, t) {
  ...
  if (t.objectMode) n = t.buffer.shift(); else if (!e || e >= t.length) {
    ...
    t.buffer.clear();
  } else n = t.buffer.consume(e, t.decoder);
  return n;
}
...
function endReadable(e) {
  ...
  if (!t.endEmitted) {
    t.ended = !0;
    onIdleA(endReadableNT.bind(null, t, e));
  }
}
...
},{"../errors":16,"./_stream_duplex":17,"./internal/streams/buffer_list":22,"./internal/streams/destroy":23,"./internal/streams/state":24,"./internal/streams/stream":25,"/bundle/utils":3,"buffer":8,"eventemitter3":13,"string_decoder/":27}],20:[function(require,module,exports){
"use strict";
...
function prefinish() {
  var t = this;
  "function" !== typeof this._flush || this._readableState.destroyed ? done(this, null, null) : this._flush(function(r, e) {
    done(t, r, e);
  });
}
...
Transform.prototype.push = function(r, e) {
  ...
  return Duplex.prototype.push.call(this, r, e);
};
...
function done(r, e, t) {
  ...
  null != t && r.push(t);
  if (r._writableState.length) throw new ERR_TRANSFORM_WITH_LENGTH_0();
  if (r._transformState.transforming) throw new ERR_TRANSFORM_ALREADY_TRANSFORMING();
  return r.push(null);
}
},{"../errors":16,"./_stream_duplex":17,"/bundle/utils":3}],21:[function(require,module,exports){
"use strict";
...
function writeAfterEnd(e, t) {
  ...
  e.emit("error", r);
  onIdleA(t.bind(null, r));
}

function validChunk(e, t, r, i) {
  var n;
  null === r ? n = new ERR_STREAM_NULL_VALUES() : "string" === typeof r || t.objectMode || (n = new ERR_INVALID_ARG_TYPE("chunk", [ "string", "Buffer" ], r));
  if (n) {
    e.emit("error", n);
    onIdleA(i.bind(null, n));
    return !1;
  }
  return !0;
}
...
Writable.prototype.write = function(e, t, r) {
  var i = this._writableState, n = !1, o = !i.objectMode && _isUint8Array(e);
  ...
  if (i.ending) writeAfterEnd(this, r); else if (o || validChunk(this, i, e, r)) {
    i.pendingcb++;
...
Writable.prototype.setDefaultEncoding = function(e) {
  ...
  if (!([ "hex", "utf8", "utf-8", "ascii", "binary", "base64", "ucs2", "ucs-2", "utf16le", "utf-16le", "raw" ].indexOf((e + "").toLowerCase()) > -1)) throw new ERR_UNKNOWN_ENCODING(e);
...
function decodeChunk(e, t, r) {
  e.objectMode || !1 === e.decodeStrings || "string" !== typeof t || (t = Buffer.from(t, r));
  return t;
}
...
function doWrite(e, t, r, i, n, o, s) {
  ...
  t.writing = !0;
  t.sync = !0;
  t.destroyed ? t.onwrite(new ERR_STREAM_DESTROYED("write")) : r ? e._writev(n, t.onwrite) : e._write(n, o, t.onwrite);
  t.sync = !1;
}
...
function onwriteError(e, t, r, i, n) {
  --t.pendingcb;
  if (r) {
    onIdleA(n.bind(null, i));
    onIdleA(finishMaybe.bind(null, e, t));
...
function onwrite(e, t) {
  ...
  if (t) onwriteError(e, r, i, t, n); else {
    var o = needFinish(r);
    o || r.corked || r.bufferProcessing || !r.bufferedRequest || clearBuffer(e, r);
    i ? onIdleA(afterWrite.bind(null, e, r, o, n)) : afterWrite(e, r, o, n);
  }
}
...
function clearBuffer(e, t) {
  ...
  if (e._writev && r && r.next) {
    var i = new Array(t.bufferedRequestCount), n = t.corkedRequestsFree;
    n.entry = r;
    var o = 0, s = !0;
    while (r) {
      (i[o] = r).isBuf || (s = !1);
    ...
    while (r) {
      var f = r.chunk;
      doWrite(e, t, !1, t.objectMode ? 1 : f.length, f, r.encoding, r.callback);
      r = r.next;
...
function prefinish(e, t) {
  if (!t.prefinished && !t.finalCalled) if ("function" !== typeof e._final || t.destroyed) {
    ...
    t.pendingcb++;
    t.finalCalled = !0;
    onIdleA(callFinal.bind(null, e, t));
  }
}
...
function endWritable(e, t, r) {
  t.ending = !0;
  finishMaybe(e, t);
  r && (t.finished ? onIdleA(r.bind(null)) : e.once("finish", r));
...
},{"../errors":16,"./_stream_duplex":17,"./internal/streams/destroy":23,"./internal/streams/state":24,"./internal/streams/stream":25,"/bundle/utils":3,"buffer":8}],22:[function(require,module,exports){
"use strict";

var Buffer = require("buffer").Buffer;

function copyBuffer(t, e, i) {
  Buffer.prototype.copy.call(t, e, i);
}
...
module.exports = function() {
  ...
  BufferList.prototype.consume = function(t, e) {
    var i;
  ...
  BufferList.prototype.first = function() {
    return this.head.data;
  };
  BufferList.prototype._getString = function(t) {
    var e = this.head, i = 1, h = e.data;
    t -= h.length;
    while (e = e.next) {
      var a = e.data, n = t > a.length ? a.length : t;
      h += n === a.length ? a : a.slice(0, t);
      if (0 === (t -= n)) {
        if (n === a.length) {
          ++i;
          this.head = e.next ? e.next : this.tail = null;
        } else (this.head = e).data = a.slice(n);
        break;
      }
      ++i;
    }
  ...
  BufferList.prototype._getBuffer = function(t) {
    var e = Buffer.allocUnsafe(t), i = this.head, h = 1;
    i.data.copy(e);
    t -= i.data.length;
    while (i = i.next) {
      var a = i.data, n = t > a.length ? a.length : t;
      a.copy(e, e.length - t, 0, n);
      if (0 === (t -= n)) {
        if (n === a.length) {
          ++h;
          this.head = i.next ? i.next : this.tail = null;
        } else (this.head = i).data = a.slice(n);
        break;
      }
      ++h;
    }
...
function destroy(t, e) {
  ...
  if (this._readableState && this._readableState.destroyed || this._writableState && this._writableState.destroyed) {
    e ? e(t) : !t || this._writableState && this._writableState.errorEmitted || onIdleA(emitErrorNT.bind(null, this, t));
    return this;
  }
  ...
  this._destroy(t || null, function(t) {
    if (!e && t) {
      onIdleA(emitErrorAndCloseNT.bind(null, i, t));
      i._writableState && (i._writableState.errorEmitted = !0);
    } else if (e) {
      onIdleA(emitCloseNT.bind(null, i));
      e(t);
    } else onIdleA(emitCloseNT.bind(null, i));
  });
  return this;
}
...
function getHighWaterMark(r, e, t, a) {
  var h = highWaterMarkFrom(e, a, t);
  if (null == h) return r.objectMode ? 16 : 16384;
  if (!Number.isInteger(h) || h < 0) throw new ERR_INVALID_OPT_VALUE(a ? t : "highWaterMark", h);
  return Math.floor(h);
}
...
},{"../../../errors":16}],25:[function(require,module,exports){
module.exports = require("eventemitter3").EventEmitter;
},{"eventemitter3":13}],26:[function(require,module,exports){
...
exports.mdhd.encode = function(e, t, r) {
  if (1 === e.version) {
    t = t ? t.slice(r) : Buffer.allocUnsafe(32);
    writeDate64(e.ctime || new Date(), t, 0);
    writeDate64(e.mtime || new Date(), t, 8);
    t.writeUInt32BE(e.timeScale || 0, 16);
    t.writeUIntBE(e.duration || 0, 20, 6);
    t.writeUInt16BE(e.language || 0, 28);
    t.writeUInt16BE(e.quality || 0, 30);
...
exports.mdhd.decode = function(e, t, r) {
  e = e.slice(t);
  return r - t !== 20 ? {
    ctime: readDate64(e, 0),
    mtime: readDate64(e, 8),
...
exports.co64.encode = function(e, t, r) {
  var n = e.entries || [];
  (t = t ? t.slice(r) : Buffer.allocUnsafe(exports.co64.encodingLength(e))).writeUInt32BE(n.length, 0);
  for (var o = 0; o < n.length; o++) uint64be.encode(n[o], t, 8 * o + 4);
  exports.co64.encode.bytes = 4 + 8 * n.length;
  return t;
};

exports.co64.decode = function(e, t) {
  for (var r = (e = e.slice(t)).readUInt32BE(0), n = new Array(r), o = 0; o < r; o++) n[o] = uint64be.decode(e, 8 * o + 4);
  return {
    entries: n
  };
};

exports.co64.encodingLength = function(e) {
...
exports.trun.encode = function(e, t, r) {
  ...
  for (var n = 8, o = 0; o < e.entries.length; o++) {
    ...
    n += 4;
    0 === (e.version || 0) ? t.writeUInt32BE(i.sampleCompositionTimeOffset, n) : t.writeInt32BE(i.sampleCompositionTimeOffset, n);
    n += 4;
  }
...
function writeDate64(e, t, r) {
  t.writeUIntBE(Math.floor((e.getTime() + TIME_OFFSET) / 1e3), r, 6);
}
...
function readDate64(e, t) {
  return new Date(1e3 * e.readUIntBE(t, 6) - TIME_OFFSET);
}
...
},{"./descriptor":29,"./index":30,"buffer":8,"uint64be":75}],29:[function(require,module,exports){
...
Box.decode = function(e, t, o) {
  ...
  return !n || n.length > o - t ? new Error("Unsupported media format, data too short...") : Box.decodeWithoutHeaders(n, e, t + n.headersLen, t + n.length);
};
...
},{"./boxes":28,"buffer":8,"uint64be":75}],31:[function(require,module,exports){
...
},{"/bundle/utils":3,"buffer":8,"mp4-box-encoding":30,"next-event":46,"readable-stream":44}],32:[function(require,module,exports){
...
},{"/bundle/utils":3,"buffer":8,"mp4-box-encoding":30,"readable-stream":44}],33:[function(require,module,exports){
exports.decode = require("./decode");

exports.encode = require("./encode");
},{"./decode":31,"./encode":32}],34:[function(require,module,exports){
arguments[4][16][0].apply(exports,arguments)
},{"/bundle/utils":3,"dup":16}],35:[function(require,module,exports){
arguments[4][17][0].apply(exports,arguments)
},{"./_stream_readable":37,"./_stream_writable":39,"/bundle/utils":3,"dup":17}],36:[function(require,module,exports){
arguments[4][18][0].apply(exports,arguments)
},{"./_stream_transform":38,"/bundle/utils":3,"dup":18}],37:[function(require,module,exports){
arguments[4][19][0].apply(exports,arguments)
},{"../errors":34,"./_stream_duplex":35,"./internal/streams/buffer_list":40,"./internal/streams/destroy":41,"./internal/streams/state":42,"./internal/streams/stream":43,"/bundle/utils":3,"buffer":8,"dup":19,"eventemitter3":13,"string_decoder/":45}],38:[function(require,module,exports){
arguments[4][20][0].apply(exports,arguments)
},{"../errors":34,"./_stream_duplex":35,"/bundle/utils":3,"dup":20}],39:[function(require,module,exports){
arguments[4][21][0].apply(exports,arguments)
},{"../errors":34,"./_stream_duplex":35,"./internal/streams/destroy":41,"./internal/streams/state":42,"./internal/streams/stream":43,"/bundle/utils":3,"buffer":8,"dup":21}],40:[function(require,module,exports){
arguments[4][22][0].apply(exports,arguments)
},{"buffer":8,"dup":22}],41:[function(require,module,exports){
arguments[4][23][0].apply(exports,arguments)
},{"dup":23}],42:[function(require,module,exports){
arguments[4][24][0].apply(exports,arguments)
},{"../../../errors":34,"dup":24}],43:[function(require,module,exports){
arguments[4][25][0].apply(exports,arguments)
},{"dup":25,"eventemitter3":13}],44:[function(require,module,exports){
arguments[4][26][0].apply(exports,arguments)
},{"./lib/_stream_duplex.js":35,"./lib/_stream_passthrough.js":36,"./lib/_stream_readable.js":37,"./lib/_stream_transform.js":38,"./lib/_stream_writable.js":39,"dup":26}],45:[function(require,module,exports){
arguments[4][27][0].apply(exports,arguments)
},{"buffer":8,"dup":27}],46:[function(require,module,exports){
...
},{"wrappy":76}],48:[function(require,module,exports){
...
module.exports = pump;
},{"end-of-stream":12,"once":47}],49:[function(require,module,exports){
"use strict";

var _require = require("readable-stream"), Writable = _require.Writable, PassThrough = _require.PassThrough, RangeSliceStream = function(i) {
  require("/bundle/utils").inherit(RangeSliceStream, i);
  function RangeSliceStream(e, t) {
    var r;
    void 0 === t && (t = {});
    (r = i.call(this, t) || this).destroyed = !1;
    r._queue = [];
    r._position = e || 0;
    r._cb = null;
    r._buffer = null;
  ...
  var e = RangeSliceStream.prototype;
  e._write = function(e, t, r) {
    ...
    while (1) {
      ...
      this._buffer = null;
      var s = this._queue[0], n = Math.max(s.start - this._position, 0), u = s.end - this._position;
      if (n >= e.length) {
      ...
      if (u > e.length) {
        this._position += e.length;
        l = 0 === n ? e : e.slice(n);
        i = s.stream.write(l) && i;
        break;
      }
      this._position += u;
      l = 0 === n && u === e.length ? e : e.slice(n, u);
      i = s.stream.write(l) && i;
      s.last && s.stream.end();
      e = e.slice(u);
      this._queue.shift();
    }
    i ? r(null) : s.stream.once("drain", r.bind(null, null));
  };
  e.slice = function(r) {
    var i = this;
...
},{"/bundle/utils":3,"readable-stream":60}],50:[function(require,module,exports){
arguments[4][16][0].apply(exports,arguments)
},{"/bundle/utils":3,"dup":16}],51:[function(require,module,exports){
arguments[4][17][0].apply(exports,arguments)
},{"./_stream_readable":53,"./_stream_writable":55,"/bundle/utils":3,"dup":17}],52:[function(require,module,exports){
arguments[4][18][0].apply(exports,arguments)
},{"./_stream_transform":54,"/bundle/utils":3,"dup":18}],53:[function(require,module,exports){
arguments[4][19][0].apply(exports,arguments)
},{"../errors":50,"./_stream_duplex":51,"./internal/streams/buffer_list":56,"./internal/streams/destroy":57,"./internal/streams/state":58,"./internal/streams/stream":59,"/bundle/utils":3,"buffer":8,"dup":19,"eventemitter3":13,"string_decoder/":61}],54:[function(require,module,exports){
arguments[4][20][0].apply(exports,arguments)
},{"../errors":50,"./_stream_duplex":51,"/bundle/utils":3,"dup":20}],55:[function(require,module,exports){
arguments[4][21][0].apply(exports,arguments)
},{"../errors":50,"./_stream_duplex":51,"./internal/streams/destroy":57,"./internal/streams/state":58,"./internal/streams/stream":59,"/bundle/utils":3,"buffer":8,"dup":21}],56:[function(require,module,exports){
arguments[4][22][0].apply(exports,arguments)
},{"buffer":8,"dup":22}],57:[function(require,module,exports){
arguments[4][23][0].apply(exports,arguments)
},{"dup":23}],58:[function(require,module,exports){
arguments[4][24][0].apply(exports,arguments)
},{"../../../errors":50,"dup":24}],59:[function(require,module,exports){
arguments[4][25][0].apply(exports,arguments)
},{"dup":25,"eventemitter3":13}],60:[function(require,module,exports){
arguments[4][26][0].apply(exports,arguments)
},{"./lib/_stream_duplex.js":51,"./lib/_stream_passthrough.js":52,"./lib/_stream_readable.js":53,"./lib/_stream_transform.js":54,"./lib/_stream_writable.js":55,"dup":26}],61:[function(require,module,exports){
arguments[4][27][0].apply(exports,arguments)
},{"buffer":8,"dup":27}],62:[function(require,module,exports){
arguments[4][16][0].apply(exports,arguments)
},{"/bundle/utils":3,"dup":16}],63:[function(require,module,exports){
arguments[4][17][0].apply(exports,arguments)
},{"./_stream_readable":65,"./_stream_writable":67,"/bundle/utils":3,"dup":17}],64:[function(require,module,exports){
arguments[4][18][0].apply(exports,arguments)
},{"./_stream_transform":66,"/bundle/utils":3,"dup":18}],65:[function(require,module,exports){
arguments[4][19][0].apply(exports,arguments)
},{"../errors":62,"./_stream_duplex":63,"./internal/streams/buffer_list":68,"./internal/streams/destroy":69,"./internal/streams/state":70,"./internal/streams/stream":71,"/bundle/utils":3,"buffer":8,"dup":19,"eventemitter3":13,"string_decoder/":73}],66:[function(require,module,exports){
arguments[4][20][0].apply(exports,arguments)
},{"../errors":62,"./_stream_duplex":63,"/bundle/utils":3,"dup":20}],67:[function(require,module,exports){
arguments[4][21][0].apply(exports,arguments)
},{"../errors":62,"./_stream_duplex":63,"./internal/streams/destroy":69,"./internal/streams/state":70,"./internal/streams/stream":71,"/bundle/utils":3,"buffer":8,"dup":21}],68:[function(require,module,exports){
arguments[4][22][0].apply(exports,arguments)
},{"buffer":8,"dup":22}],69:[function(require,module,exports){
arguments[4][23][0].apply(exports,arguments)
},{"dup":23}],70:[function(require,module,exports){
arguments[4][24][0].apply(exports,arguments)
},{"../../../errors":62,"dup":24}],71:[function(require,module,exports){
arguments[4][25][0].apply(exports,arguments)
},{"dup":25,"eventemitter3":13}],72:[function(require,module,exports){
arguments[4][26][0].apply(exports,arguments)
},{"./lib/_stream_duplex.js":63,"./lib/_stream_passthrough.js":64,"./lib/_stream_readable.js":65,"./lib/_stream_transform.js":66,"./lib/_stream_writable.js":67,"dup":26}],73:[function(require,module,exports){
arguments[4][27][0].apply(exports,arguments)
},{"buffer":8,"dup":27}],74:[function(require,module,exports){
var Buffer = require("buffer").Buffer;
...
function VideoStream(e, r, t) {
  ...
  i._elem.autoplay && (i._elem.preload = "auto");
...
},{"./ebml-remuxer":4,"./mp4-remuxer":5,"mediasource":15,"pump":48,"to-arraybuffer":74}]},{},[2]);

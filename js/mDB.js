    ...
    function mDBprocess()
    {
        ...
        for (var t in mDBqueue)
        {
            ...
            while (mDBi[t] < mDBqueue[t].length)
            {
                ...
                {
                    if (mDBqueue[t][mDBi[t]].a)
                        var request = mDBt.objectStore.put(mDBqueue[t][mDBi[t]].a);
        ...
        objectStore.openCursor().onsuccess = function (event)
        {
            ...
            if (rec)
            {
                ...
                if (typeof value === 'undefined')
                    ...
                    process_ok([rec.value]);
                else if (t == 'f')
                    M.addNode(rec.value, 1);
                else if (t == 'f_sk')
                {
                    var n = rec.value;
                    if (n.sk)
                    ...
                    M.addUser(rec.value, 1);
                else if (t == 's')
                    M.nodeShare(rec.value.h, rec.value, 1);
                else if (t === 'opc')
                    M.addOPC(rec.value);
                else if (t === 'ipc')
                    M.addIPC(rec.value);

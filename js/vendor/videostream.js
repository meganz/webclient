 ...
 * $Id: videostream.js,v 3.1.0 2018/10/11 17:58:07 dc Exp $
 */
...
function AudioStream(t, e, i) {
  ...
  (a._fileStream = o).on("data", function(t) {
    var e = a._buffer;
...
Visualiser.prototype.draw = function(t, e, i, a, r) {
  var o, s, n, u, h, d = 0, l = t.byteLength;
  ...
  while (l--) e.fillRect(5 * l, (a - (o = t[l] / 1.4)) / 1.2, 4, o / 1.3);
  e.closePath();
...
Streamer.prototype.initTypeGuess = function(s) {
  ...
  t.fetcher(s, 0, 16).then(function(e) {
    ...
    440786851 === r ? a.options.type = "WebM" : r >> 8 === 4801587 ? a.options.type = "MPEG Audio" : 1332176723 === r ? a.options.type = "Ogg" : 1295270176 === i.getUint32(8, !1) ? a.options.type = "M4A " : 1463899717 === i.getUint32(8, !1) && (a.options.type = "Wave");
  ...
  return new Promise(function _(e, t) {
    if (l.videoWidth) {
      ...
      if (Math.round(100 * h / n) > 70) {
        ...
        l.paused || l.ended ? onIdle(function() {
          t(-5);
...
Object.defineProperty(Streamer.prototype, "currentTime", {
  ...
  set: function(e) {
    ...
    if (i instanceof AudioStream) {
      ...
      i._play(e);
      this.play();
    } else t.currentTime = e + this.presentationOffset;
  }
});

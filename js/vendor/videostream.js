 ...
 * $Id: videostream.js,v 2.4.2 2018/01/10 00:15:47 dc Exp $
 */
 ...
 */ function Streamer(e, t, i) {
  ...
  if (t.parentNode && "Gecko" === ua.details.engine) {
    r = !0;
  ...
  this.stream = new VideoStream(this.file.fetch(0), t, a);
...
VideoStream.prototype.flushSourceBuffers = function(e) {
  this.forEachSourceBuffer(function(r, t, i, o, n) {
    d && console.debug("[VideoStream.flushSourceBuffers] ct=%s sr=%s er=%s", o, t, i, r.updating, n.readyState, r);
    if (!r.updating) {

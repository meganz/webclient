 ...
 * $Id: videostream.js,v 2.5.1 2018/03/12 03:55:12 dc Exp $
 */
...
function VideoFile(e, t) {
  ...
  this.cachepos = [];
  this.curfetch = this.mru = this.cachesize = 0;
  this.filesize = -1;
  this.throttle = 0;
  this.backoff = 200;
  this.paused = !0;
  this.canplay = this.playing = !1;
    ...
    if (!(t < 1)) {
      ...
      this.fetcher(this.data, n, n + t).then(function(e) {
        ...
        if (void 0 !== o.mru) {
          delete o.fetching[n];
          var r = function() {
            setImmediate(o.fetch.bind(o, s, a));
          };
          if ("number" === typeof e) {
            if (e !== ERANGE || t && n < t.s) {
 ...
 */ function Streamer(e, t, i) {
  ...
  if (t.parentNode && "Gecko" === r.engine && parseInt(r.version) < 57) {
    this.sbflush = !0;
  ...
  this.video = t;
  this.timeupdate = 0;
  this.inactivity = this.stalled = !1;
...
Streamer.prototype.init = function(e) {
  if (this.video) {
    ...
    !1 === this.options.autoplay ? this.file.minCache = 16777216 : this.video.setAttribute("autoplay", !0);
    var t = {
      sbflush: this.sbflush,
      type: this.options.type,
      bufferDuration: 1.8 * MAX_BUF_SECONDS
    };
    this.stream = new VideoStream(this.file.fetch(0), this.video, t);
    this.file._vs = this.stream;
  } else d && console.debug("Cannot initialize... already destroyed?", this);
};

Streamer.prototype.initTypeGuess = function(i) {
  var r = this, t = new VideoFile(i, r), s = function(e) {
    t.destroy();
    r.init(e);
  };
  t.fetcher(i, 0, 4).then(function(e) {
    var t = new DataView(e.buffer);
    delete e.buffer;
    440786851 === t.getUint32(0, !1) && (r.options.type = "WebM");
    s("string" === typeof i ? e : i);
  }).catch(function(e) {
...
Streamer.prototype.getImage = function(c, l) {
  var f = this, u = this.video;
  return new Promise(function _(e, t) {
    if (!u.videoWidth) return t(-9);
    var i = f.dim(u.videoWidth, u.videoHeight, c || 1280, l || 720);
    d && console.debug("[Streamer.getImage()] Taking %sx%s image from %sx%s at %s", i.width, i.height, u.videoWidth, u.videoHeight, secondsToTime(u.currentTime));
    var r = document.createElement("canvas"), s = r.getContext("2d");
    r.width = Math.round(i.width);
    r.height = Math.round(i.height);
    s.drawImage(u, 0, 0, r.width, r.height);
    ...
    if (Math.round(100 * h / n) > 70) {
      ...
      u.paused ? t(-5) : u.ended ? t(-8) : setTimeout(_.bind(this, e, t), 800);
...
Streamer.getThumbnail = function(n) {
  return new Promise(function(t, i) {
    ...
    s.on("playing", function() {
      if (!++r) {
        e.currentTime = 20 * (0 | e.duration) / 100;
        return !0;
      }
...
},{"../":38,"/bundle/utils":2,"buffer":7,"readable-stream":33}],2:[function(require,module,exports){
...
var utils = {
  debuglog: function(e) {
    if (d > 8) {
      var n = MegaLogger.getLogger(e);
      return n.debug.bind(n);
    }
    return function() {};
  },
  nextTick: function() {
...
function EBMLRemuxer(e) {
  ...
  this._tracks = [];
  this._seekTime = -1;
  this._seekTable = this._hasAudio = this._hasVideo = !1;
...
function EBMLReader(e, t) {
  ...
  this._conGroup = 0;
  this._cluster = null;
  this._timecodes = [ this._segmentOffset = this._clusterCount = this._ebmlOffset = 0, 0 ];
  this._byteOffset = t;
...
createStream(EBMLReader, stream.Writable, function() {
  ...
  this._cluster = this.$buffer = null;
...
},{"/bundle/utils":2,"buffer":7,"ebml/lib/ebml/decoder":8,"eventemitter3":12,"readable-stream":33}],4:[function(require,module,exports){
...
MP4Remuxer.prototype._processMoov = function(e) {
  ...
  for (var a = 0; a < s.length; a++) {
    var n, i, o = s[a], m = o.mdia.minf.stbl, f = m.stco || m.co64, c = m.stsd.entries[0], u = o.mdia.hdlr.handlerType;
    d && console.debug("handler=%s, type=%s, trak:", u, c.type, o);
    if (t._hasVideo || "vide" !== u || "avc1" !== c.type) {
      if (t._hasAudio || "soun" !== u || "mp4a" !== c.type && "fLaC" !== c.type) continue;
      if ("mp4a" === c.type) {
        n = "mp4a";
        c.esds && c.esds.mimeCodec && (n += "." + c.esds.mimeCodec);
        r[n] && (n = "mp3");
      } else n = "flac";
...
},{"/bundle/utils":2,"binary-search":6,"buffer":7,"eventemitter3":12,"mp4-box-encoding":17,"mp4-stream":20,"range-slice-stream":24}],5:[function(require,module,exports){
"use strict";
...
function encodeChunk(o, r, e) {
  for (var t = [], u = r; u < e; u += 3) t.push(tripletToBase64((o[u] << 16 & 16711680) + (o[u + 1] << 8 & 65280) + (255 & o[u + 2])));
  return t.join("");
}
...
},{"base64-js":5,"ieee754":13}],8:[function(require,module,exports){
...
},{"./schema.js":9,"./tools.js":10,"/bundle/utils":2,"buffer":7,"readable-stream":33}],9:[function(require,module,exports){
...
module.exports = eos;
},{"once":22}],12:[function(require,module,exports){
"use strict";
...
MediaSourceStream.prototype._write = function(r, t, o) {
  ...
  if (!a.destroyed) if (a._sourceBuffer) {
    ...
    try {
      a._sourceBuffer.appendBuffer(toArrayBuffer(r));
    } catch (e) {
      a.destroy(e);
      return;
    }
...
},{"/bundle/utils":2,"readable-stream":33,"to-arraybuffer":35}],15:[function(require,module,exports){
...
},{"./descriptor":16,"./index":17,"buffer":7}],16:[function(require,module,exports){
...
exports.Descriptor.decode = function(r, e, o) {
  ...
  var n = tagToName[i];
  (c = exports[n] ? exports[n].decode(r, s, o) : {
...
},{"./boxes":15,"buffer":7,"uint64be":36}],18:[function(require,module,exports){
...
function Decoder() {
  ...
  this.destroyed = !1;
  this._missing = this._pending = 0;
  this._ondrain = this._writeCb = this._writeBuffer = this._ondrain = this._cb = this._str = this._buf = null;
  this._kick();
}
...
Decoder.prototype._buffer = function(e, t) {
  this._buf = new Buffer(this._missing = e);
  this._cb = t;
};
...
Decoder.prototype._kick = function() {
  if (!this._pending) {
    ...
    if (this._writeBuffer) {
      var e = this._writeCb;
      this._write(this._writeBuffer, this._writeCb = this._writeBuffer = null, e);
    }
  }
};
...
},{"/bundle/utils":2,"buffer":7,"mp4-box-encoding":17,"next-event":21,"readable-stream":33}],19:[function(require,module,exports){
...
function Encoder() {
  ...
  this._reading = this.destroyed = !1;
  this._drain = this._stream = null;
  this._want = !1;
...
},{"/bundle/utils":2,"buffer":7,"mp4-box-encoding":17,"readable-stream":33}],20:[function(require,module,exports){
...
},{"wrappy":37}],23:[function(require,module,exports){
...
module.exports = pump;
},{"end-of-stream":11,"once":22}],24:[function(require,module,exports){
...
},{"/bundle/utils":2,"readable-stream":33}],25:[function(require,module,exports){
"use strict";
...
Object.defineProperty(Duplex.prototype, "destroyed", {
  ...
  set: function(e) {
    void 0 !== this._readableState && void 0 !== this._writableState && (this._writableState.destroyed = this._readableState.destroyed = e);
  }
});
...
function forEach(e, t) {
  for (var a = 0, i = e.length; a < i; a++) t(e[a], a);
}
},{"./_stream_readable":27,"./_stream_writable":29,"/bundle/utils":2}],26:[function(require,module,exports){
"use strict";
...
},{"./_stream_transform":28,"/bundle/utils":2}],27:[function(require,module,exports){
"use strict";
...
},{"./_stream_duplex":25,"./internal/streams/BufferList":30,"./internal/streams/destroy":31,"./internal/streams/stream":32,"/bundle/utils":2,"buffer":7,"eventemitter3":12,"string_decoder/":34}],28:[function(require,module,exports){
"use strict";
...
},{"./_stream_duplex":25,"/bundle/utils":2}],29:[function(require,module,exports){
"use strict";
...
function WritableState(e, t) {
  ...
  this.highWaterMark = Math.floor(this.highWaterMark);
  this.decodeStrings = !((this.destroyed = this.finished = this.ended = this.ending = this.needDrain = this.finalCalled = !1) === e.decodeStrings);
  this.defaultEncoding = e.defaultEncoding || "utf8";
  this.length = 0;
  this.writing = !1;
  this.sync = !(this.corked = 0);
...
},{"./_stream_duplex":25,"./internal/streams/destroy":31,"./internal/streams/stream":32,"/bundle/utils":2,"buffer":7}],30:[function(require,module,exports){
"use strict";
...
function undestroy() {
  this._readableState && (this._readableState.endEmitted = this._readableState.ended = this._readableState.reading = this._readableState.destroyed = !1);
  this._writableState && (this._writableState.errorEmitted = this._writableState.finished = this._writableState.ending = this._writableState.ended = this._writableState.destroyed = !1);
}
...
},{"/bundle/utils":2}],32:[function(require,module,exports){
module.exports = require("eventemitter3").EventEmitter;
},{"eventemitter3":12}],33:[function(require,module,exports){
...
function utf8CheckExtraBytes(t, e, s) {
  ...
  if (t.lastNeed > 1 && e.length > 1) {
    if (128 !== (192 & e[1])) return "\ufffd".repeat(s + (t.lastNeed = 1));
    if (t.lastNeed > 2 && e.length > 2 && 128 !== (192 & e[2])) return "\ufffd".repeat(s + (t.lastNeed = 2));
  }
}
...
VideoStream.prototype._createMuxer = function() {
  ...
  i._muxer.once("ready", function(e) {
    ...
    (i._waitingFired || "auto" === i._elem.preload) && i._pump();
  });
...
VideoStream.prototype._pump = function() {
  try {
    var e = this._elem.currentTime;
    this.withinBufferedRange(e) ? d && console.debug("Ignoring pump within buffered range.", e) : this._tryPump();
  } catch (e) {
...
VideoStream.prototype._tryPump = function() {
  var o = this, e = o._elem, r = o._muxer, u = e.currentTime, n = r.seek(u), a = r._seekTimeFixup;
  d && console.debug("Seeking to %s, fixup=%s", u, a);
  if (u - a > .4 || 0 === a) {
    var t, i;
    if (o._seekCoercion !== a) {
      d && console.debug("Applying timestamp fixup...", u, a);
      for (t = n.length; t--; ) {
        (i = n[t]).inStream && i.inStream.destroy();
        i.outStream && i.outStream.destroy();
      }
      this.withinBufferedRange(e.currentTime = o._seekCoercion = a) || this._tryPump();
      return;
    }
    d && console.debug("Seek coercion, waiting for more data...");
  }
  o._tracks.forEach(function(t, i) {
    var r = function() {
      if (t.muxed) {
        var e = t.mediaSource, r = e && e._sourceBuffer;
        t.muxed.destroy();
        t.mediaSource = o.createWriteStream(e);
        if (r) {
          "audio/mpeg" === e._type && (r.timestampOffset = u);
          void 0 !== a && o.removeBuffered(r, u);
        }
      }
      t.muxed = n[i];
...
},{"./ebml-remuxer":3,"./mp4-remuxer":4,"mediasource":14,"pump":23,"to-arraybuffer":35}]},{},[1]);

...
"use strict";
 ...
 const _babel_runtime_helpers_extends6__ = REQ_(8168);
 const react0__ = REQ_(1594);
 const react0___default = REQ_.n(react0__);
 const _mixins1__ = REQ_(8264);
 const _ui_utils_jsx5__ = REQ_(6411);
 const _ui_perfectScrollbar_jsx7__ = REQ_(1301);
 const _ui_buttons_jsx3__ = REQ_(5155);
 const _ui_dropdowns_jsx2__ = REQ_(1510);
 const _ui_modalDialogs10__ = REQ_(8120);
 const _link_jsx8__ = REQ_(4649);
 const _updateObserver_jsx4__ = REQ_(4372);
 const _contactsPanel_utils_jsx9__ = REQ_(836);
...
class ContactButton extends _mixins1__ .u9 {
  ...
  dropdownItemGenerator() {
    ...
    if (contact.u === u_handle) {
      moreDropdowns.push(JSX_(_ui_dropdowns_jsx2__ .tJ, {
        key: "view0",
    ...
    if (contact.c === 1) {
      ...
      if (megaChat.currentlyOpenedChat && megaChat.currentlyOpenedChat === contact.u) {
        moreDropdowns.push(JSX_("div", {
          ...
          key: "dropdownGroup"
        }, JSX_("div", null, JSX_(_ui_dropdowns_jsx2__ .tJ, {
          key: "startAudio",
          icon: "sprite-fm-mono icon-phone",
          disabled: !megaChat.hasSupportForCalls,
          label: l[1565],
  ...
  render() {
    ...
    }, label) : JSX_(_ui_buttons_jsx3__ .$, {
      className,
      icon: dropdownIconClasses,
      disabled: dropdownDisabled,
      label
    }, JSX_(_ui_dropdowns_jsx2__ .ms, {
  ...
  render() {
    ...
    if (contact.c === 1 && u_authring && u_authring.Ed25519) {
      ...
      if (typeof verifyState.method === "undefined" || verifyState.method < authring.AUTHENTICATION_METHOD.FINGERPRINT_COMPARISON) {
        verifyButton = JSX_(_ui_buttons_jsx3__ .$, {
...
class Avatar extends _mixins1__ .u9 {
  render() {
    ...
    if (avatarMeta.type === "image") {
      displayedAvatar = JSX_("div", (0,_babel_runtime_helpers_extends6__ .A)({
        className: classes,
...
class ContactCard extends _mixins1__ .u9 {
  ...
  render() {
    ...
    let escapedUsername = JSX_(_ui_utils_jsx5__ .sp, null, username);
    ...
    if (!noContextMenu) {
      ...
      if (highlightSearchValue && searchValue.length > 0) {
        ...
        if (matches.length > 0) {
          escapedUsername = JSX_(_ui_utils_jsx5__ .P9, null, megaChat.highlight(megaChat.html(username), matches, true));
        }
      }
...
class ContactItem extends _mixins1__ .u9 {
  render() {
    ...
    return JSX_("div", {
      ...
      contact,
      className: "light",
      label: JSX_(_ui_utils_jsx5__ .zT, null, username),
      chatRoom: this.props.chatRoom
    })));
  }
}
...
class ContactPickerWidget extends _mixins1__ .w9 {
  constructor(...args) {
    ...
    this.renderParticipantsList = () => {
      ...
      return JSX_(_ui_perfectScrollbar_jsx7__ .O, {
  ...
  render() {
    ...
    if (self.props.readOnly) {
      ...
      if (!self.state.selected || self.state.selected.length === 0) {
        ...
        multipleContacts = JSX_("div", {
          className: "horizontal-contacts-list"
        }, JSX_(_ui_perfectScrollbar_jsx7__ .O, {
    ...
    if (contacts.length === 0 || !(0,_contactsPanel_utils_jsx9__ .SN)() && this.props.step !== 1) {
    ...
    if (haveContacts) {
      if (frequentContacts.length === 0 && noOtherContacts) {
        ...
        contactsList = JSX_(_ui_perfectScrollbar_jsx7__ .O, {
          ref: ref => {
          ...
          className: "contacts-list-header"
        }, frequentContacts.length === 0 ? this.props.readOnly ? l[16217] : l[165] : l[165]), JSX_("div", {
          className: "contacts-search-list",
          style: innerDivStyles
        }, contacts)) : null));
      }
      ...
      }), JSX_(_ui_utils_jsx5__ .P9, null, l[19111])));
      extraClasses += " no-contacts";
    }
    ...
    })), multipleContacts, !this.props.readOnly && haveContacts && !this.props.hideSearch && JSX_(react0___default().Fragment, null, JSX_("div", {
      className: `
    ...
    }), this.props.participantsList ? this.renderParticipantsList() : contactsList, selectFooter, this.props.showAddContact && (0,_contactsPanel_utils_jsx9__ .SN)() ? JSX_("div", {
...
class ContactPickerDialog extends _mixins1__ .w9 {
  ...
  render() {
    ...
    return JSX_(_ui_modalDialogs10__ .A.ModalDialog, {
      name,
      className: `
                    ${className}
                    ${this.dialogName}
...
;// CONCATENATED MODULE: ./js/chat/ui/errorBoundary.jsx
...
class ScheduleMetaChange extends _mixin_jsx1__ .M {
  ...
  render() {
    ...
    return JSX_("div", null, JSX_("div", {
      ...
      className: "message text-block"
    }, JSX_(_ui_utils_jsx3__ .P9, null, ScheduleMetaChange.getTitleText(meta, chatRoom)), " ", !!d && meta.handle), JSX_("div", {
      className: "message body-block"
    }, mode !== MODE.CANCELLED && (meta.prevTiming || meta.calendar || meta.topic && meta.onlyTitle || meta.recurring) && JSX_("div", {
...
"use strict";
 ...
 const _babel_runtime_helpers_extends2__ = REQ_(8168);
 const react0__ = REQ_(1594);
 const react0___default = REQ_.n(react0__);
 const _mixins_js1__ = REQ_(8264);
...
const withUpdateObserver = Component => class extends _mixins_js1__ .w9 {
  constructor(...args) {
    ...
    this.instanceRef = react0___default().createRef();
  ...
  render() {
    return JSX_(Component, (0,_babel_runtime_helpers_extends2__ .A)({
...
"use strict";
 ...
 const react0__ = REQ_(1594);
 const react0___default = REQ_.n(react0__);
 const _chat_mixins_js1__ = REQ_(8264);
...
class Button extends _chat_mixins_js1__ .w9 {
  constructor(props) {
    ...
    this.onClick = e => {
      ...
      if (this.state.focused === false) {
        ...
        } else if (react0___default().Children.count(this.props.children) > 0) {
          this.setState({
            focused: true
          }, () => this.safeForceUpdate());
        }
  ...
  renderChildren() {
    return this.props.children && react0___default().Children.map(this.props.children, child => child && (typeof child.type === 'string' || child.type === undefined ? child : react0___default().cloneElement(child, {
  ...
  render() {
    ...
    return JSX_(TagName, (0,_babel_runtime_helpers_extends2__ .A)({
      ref: this.domRef,
      className: `
                    button
                    ${className || ''}
...
class Dropdown extends _chat_mixins1__ .w9 {
  ...
  render() {
    ...
    return JSX_(_utils_jsx2__ .Ay.RenderTo, {
...
"use strict";
 ...
 const _perfectScrollbar_jsx2__ = REQ_(1301);





class DropdownEmojiSelector extends _chat_mixins_js1__ .w9 {
  constructor(props) {
    super(props);
    this.domRef = react0___default().createRef();
    this.emojiSearchRef = react0___default().createRef();
  ...
  _renderEmojiPickerPopup() {
    ...
    return JSX_(react0___default().Fragment, null, JSX_("div", {
      ...
      autoFocus: true,
      value: this.state.searchValue
    }))), JSX_(_perfectScrollbar_jsx2__ .O, {
  ...
  render() {
    ...
    return JSX_(_dropdowns_jsx3__ .ms, (0,_babel_runtime_helpers_extends4__ .A)({
    ...
    if (self.props.buttons) {
      ...
      if (buttons && buttons.length > 0 || extraFooterElements.length > 0) {
        footer = JSX_("footer", null, buttons && buttons.length > 0 ? JSX_("div", {
          className: "footer-container"
        }, buttons) : null, extraFooterElements.length > 0 ? JSX_("aside", null, extraFooterElements) : null);
      }
    }
...
"use strict";
 ...
 const _babel_runtime_helpers_applyDecoratedDescriptor2__ = REQ_(793);
 const react0__ = REQ_(1594);
 const react0___default = REQ_.n(react0__);
 const _chat_mixins1__ = REQ_(8264);
...
const PerfectScrollbar = (_dec = (0,_chat_mixins1__ .hG)(30, true), _dec2 = (0,_chat_mixins1__ .hG)(30, true), _class = (_PerfectScrollbar = class PerfectScrollbar extends _chat_mixins1__ .w9 {
  ...
  requiresUpdateOnResize: true
}, _PerfectScrollbar), (0,_babel_runtime_helpers_applyDecoratedDescriptor2__ .A)(_class.prototype, "eventuallyReinitialise", [_dec], Object.getOwnPropertyDescriptor(_class.prototype, "eventuallyReinitialise"), _class.prototype), (0,_babel_runtime_helpers_applyDecoratedDescriptor2__ .A)(_class.prototype, "onResize", [_dec2], Object.getOwnPropertyDescriptor(_class.prototype, "onResize"), _class.prototype), _class);
...
const chat_chatGlobalEventManager = REQ_(8676);
...
;// CONCATENATED MODULE: ./js/chat/ui/meetings/workflow/incoming.jsx
...
class Incoming extends REaCt().Component {
  ...
  render() {
    ...
    if (chatRoom) {
      ...
      return JSX_(modalDialogs.A.ModalDialog, (0,esm_extends.A)({}, this.state, {
      ...
      }, JSX_("h1", null, JSX_(ui_utils.sp, null, chatRoom.getRoomTitle())), JSX_("span", null, isPrivateRoom ? l[17878] : l[19995])), JSX_("div", {
        className: `
                                ${NAMESPACE}-controls
        ...
        onClick: onReject
      }), CALL_IN_PROGRESS ? this.renderSwitchControls() : this.renderAnswerControls()), unsupported && JSX_("div", {
...
window.chatGlobalEventManager = chat_chatGlobalEventManager.r;

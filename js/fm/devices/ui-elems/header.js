    ...
    return class {
        ...
        show(item, renderStatusFn, onClickOptionsFn, showBanner) {
            ...
            if (isDeviceFolder && t !== cameraUpload) {
                ...
                // TODO: If desktop app provides API to open MegaSync settings
                // for stopping/pausing inshare syncs with less than full access,
                // We should show the ctx menu item, as well as these header buttons

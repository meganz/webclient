 ...
 * $Id: videostream.js,v 2.6.1 2018/04/11 01:28:28 dc Exp $
 */
...
Streamer.prototype.init = function(e) {
  ...
  if (i.video) {
    ...
    if ("MPEG Audio" === t.type || "M4A " === t.type || "Wave" === t.type || "Ogg" === t.type) {
      ...
      i.gecko && this.on("stalled", function() {

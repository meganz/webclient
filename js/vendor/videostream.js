 ...
 * $Id: videostream.js,v 4.2.0 2019/08/11 10:22:06 dc Exp $
 */
...
AudioStream.prototype._setup = function(autoplay, buffer) {
  var elm = this._elem, audioContext = this._audioContext, audioStream = audioContext.createMediaStreamDestination(), videoCanvas = document.createElement("canvas"), videoContext = videoCanvas.getContext("2d"), videoStream = videoCanvas.captureStream(25), tracks = [ audioStream.stream.getTracks()[0], videoStream.getTracks()[0] ], audioAnalyser = audioContext.createAnalyser();
...
AudioVisualiser.prototype._draw = function() {
  var self = this, tick = ++self._tick, stream = self._stream, ctx = stream._videoContext, canvas = stream._videoCanvas, analiser = stream._audioAnalyser, $video = $(stream._elem).parent();

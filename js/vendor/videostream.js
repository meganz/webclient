 ...
 * $Id: videostream.js,v 5.1.0 2020/12/08 14:38:09 dc Exp $
 */
...
Streamer.prototype.handleEvent = function(ev) {
  ...
  switch (ev.type) {
   ...
   case "canplay":
    videoFile.canplay = !0;
    "canplay" === ev.type && delay.cancel("vs:pump-track");
...
VideoStream.prototype.createWriteStream = function(obj) {
  ...
  mediaSource._flow = function() {
    if (!this.destroyed && this._sourceBuffer && !this._sourceBuffer.updating && !videoFile.throttle && this._cb) {
      var cb = this._cb;
      this._cb = null;
      cb();
    }
...
VideoStream.prototype._pump = function(time) {
  try {
    ...
    if ("WebM" === this._type && this.withinBufferedRange(time)) d && console.debug("Ignoring pump within buffered range.", time); else {
      var self = this;

 ...
 * $Id: videostream.js,v 5.4.0 2022/04/12 10:28:37 dc Exp $
 */
...
function AudioStream(file, mediaElem, opts) {
  ...
  if (window.safari || "Webkit" === ua.details.engine) {
...
AudioStream.prototype._play = function(time) {
  var self = this, context = self._audioContext, visualiser = self._visualiser, audioBuffer = self._audioBuffer, source = context.createBufferSource();
  if (audioBuffer) {
    this._stop();

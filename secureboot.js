...
else 
{
	...
	{	
		...
		if (typeof JSON == 'undefined') jsl.push({f:'js/json.js', n: 'json', j:1});
		...
		var jsl2 = 
		{
			...
			'forgotpassword': {f:'html/forgotpassword.html', n: 'forgotpassword', j:0},
			'forgotpassword_js': {f:'html/js/forgotpassword.js', n: 'forgotpassword_js', j:1},

 ...
 * $Id: videostream.js,v 2.4.2 2017/12/30 02:05:30 dc Exp $
 */
...
Streamer.prototype.handleEvent = function(e) {
  ...
  if (this.evs[e.type]) {
    var r = "error" === e.type && (this.stream.detailedError || Object(t.error).message) || !1;
...
Readable.prototype.wrap = function(e) {
  ...
  for (var i in e) void 0 === this[i] && "function" == typeof e[i] && (this[i] = (a = i, 
  function() {
    return e[a].apply(e, arguments);
  }));
  for (var a, d = 0; d < kProxyEvents.length; d++) e.on(kProxyEvents[d], r.emit.bind(r, kProxyEvents[d]));
  r._read = function(t) {

 ...
 * $Id: videostream.js,v 2.6.1 2018/04/05 03:08:09 dc Exp $
 */
...
Streamer.prototype.init = function(e) {
  ...
  if (i.video) {
    ...
    } else i.stream = new VideoStream(i.file.fetch(0), i.video, t);
    i.file._vs = i.stream;
...
Streamer.prototype.initTypeGuess = function(i) {
  ...
  t.fetcher(i, 0, 4).then(function(e) {
    var t = new DataView(e.buffer).getUint32(0, !1);
    delete e.buffer;
    440786851 === t ? r.options.type = "WebM" : t >> 8 === 4801587 && (r.options.type = "MPEG Audio");
...
Streamer.prototype.getImage = function(c, l) {
  ...
  return new Promise(function _(e, t) {
    ...
    if (Math.round(100 * h / n) > 70) {
      ...
      f.paused ? t(-5) : f.ended ? t(-8) : setTimeout(_.bind(this, e, t), 800);
...
Object.defineProperty(Streamer.prototype, "currentTime", {
  get: function() {
    var e = this.stream || !1;
    return e instanceof AudioStream ? e.currentTime : (this.video || !1).currentTime;
  },
  set: function(e) {
    var t = this.video || !1, i = this.stream || !1;
    i instanceof AudioStream ? i._play(e) : t.currentTime = e;
  }
});

 ...
 * $Id: videostream.js,v 5.3.0 2021/09/30 11:09:36 dc Exp $
 */
...
Object.defineProperty(AudioStream.prototype, "currentTime", {
  get: function() {
    ...
    if (result >= (this._audioBuffer || !1).duration) if (this.ready) this._elem.pause(); else {
      this._onPause();
...
Streamer.prototype.handleEvent = function(ev) {
  ...
  switch (ev.type) {
   ...
   case "stalled":
    if (!this.isOverQuota) if (videoFile.playing) {
      var stream = this.stream;
      stream.findTimeGAPs() && stream._enqueueForcePump();
...
MediaSegment.prototype.append = function(cluster, timecode, duration) {
  ...
  if (16777216 === cs) timecodeOffset = 12; else if (cs >> 24 === 255) timecodeOffset = 5; else if (DEBUG_TRACE) {
...
function MP4Remuxer(file, opts) {
  ...
  this._file = file;
  this._decoder = null;
  this._videoOnly = opts && opts.videoOnly;
  this._findMoov(0);
}
...
MP4Remuxer.prototype._processTracks = function(traks) {
  ...
  for (var mime, codec, self = this, audio = [], hevc = Object.assign(Object.create(null), {
    ...
    } else if ("soun" === type && !self._videoOnly) {
...
VideoStream.prototype._forcePump = function(offset) {
  ...
  self._fpTick = 0;
  delay.cancel("vs.force-track-pump");
  if (this._tracks) for (var t = this._tracks, i = t.length; i--; ) {
    var ms = t[i].mediaSource, sb = ms._sourceBuffer;
    ++step;
    ms._cb = null;
    ms.destroy();
    if (sb.updating) {
    ...
    } else res |= this.removeBuffered(sb, null, pump);
  }
  step || pump(++step);
  return res;
};

...
const getUserFingerprint = handle => {
 ...
 REQ_.d(EXP_, [
   "SN", 0,  hasContacts,
   "U_", 0,  resetCredentials,
   "X7", 0,  hasRelationship,
   "d_", 0,  LABEL,
   "gR", 0,  VIEW,
   "p4", 0,  isVerified,
   "qH", 0,  verifyCredentials,
   "qY", 0,  EVENTS,
   "ym", 0,  getUserFingerprint
 ]);
...
const renderEndConfirm = (onConfirm, onRecordingToggle) => msgDialog(`confirmation:!^${l.end_call_recording_dialog_cta}!${l.end_call_recording_dialog_nop_cta}`, undefined, l.end_call_recording_dialog_heading, l.end_call_recording_dialog_body, cb => {
 ...
 REQ_.d(EXP_, [
   ...
   "Cy", 0,  isModerator,
   "Fj", 0,  EXPANDED_FLAG,
   "HV", 0,  getUnsupportedBrowserMessage,
   "P", 0,  isGuest,
   "ZE", 0,  TYPE,
   "_F", 0,  renderEndConfirm,
   "dQ", 0,  inProgressAlert,
   "g", 0,  MODE,
   "gR", 0,  VIEW,
   "gh", 0,  STREAMS_PER_PAGE,
   "hK", 0,  STREAM_ACTIONS,
   "sX", 0,  renderLeaveConfirm
 ]);

 ...
 * $Id: videostream.js,v 5.5.0 2024/02/12 13:34:10 dc Exp $
 */
...
function AudioStream(file, mediaElem, opts) {
  ...
  self._onPlay = function() {
    self._audioStream && self._play(self._ended ? 0 : self._timeOffset);
  };
...
Object.defineProperty(AudioStream.prototype, "currentTime", {
  get: function() {
    ...
    if (result >= audioBuffer.duration) {
      ...
      if (this.ready) this._endOfStream(); else {
        this._onPause();
...
Object.defineProperty(Streamer.prototype, "ended", {
  get: function() {
    return (this.video || !1).ended || this.stream instanceof AudioStream && this.currentTime + .01 >= this.duration;
  }
});

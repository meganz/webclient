...
class MegaXXXTest(unittest.TestCase):
    """Class docstring"""
    def setUp(self):
    ...
    def test_suite(self):
        ...
        test.login_popup()
        testname = 'template'
        # Test XXXX testname e.g. tpp enable disable
        print testname + ' start'

        # common_tests.login_popup(self, self.driver, self.username, self.password)

        print testname + ' finished'

# Finished class MegaXXXTest

 ...
 * $Id: videostream.js,v 4.1.0 2019/03/21 17:07:39 dc Exp $
 */
...
},{"/bundle/utils":3,"buffer":8,"eventemitter3":13,"to-arraybuffer":38}],2:[function(require,module,exports){
"use strict";
...
Streamer.prototype._setActivityTimer = function() {
  ...
  this.activitimer = setTimeout(function() {
    ...
    if (!e.paused && !e.ended || !t.file.bgtask && t.isOverQuota) {
      t.stalled = !0;
      t.notify("inactivity");
      if ("suspend" === t.state && !t.playbackEvent) {
...
Object.defineProperty(Streamer.prototype, "currentTime", {
  ...
  set: function(e) {
    var t = this, i = t.video || !1, r = t.stream || !1;
    if (r instanceof AudioStream) {
      r._stop();
      r._play(e);
      t.play();
    } else if (i.readyState) {
      var s = e + t.presentationOffset;
      i.currentTime = s;
      t.msie && r._pump(s);
      t.play();
...
},{"../audiostream":1,"../videostream":41,"/bundle/utils":3,"buffer":8,"readable-stream":36}],3:[function(require,module,exports){
...
EBMLRemuxer.prototype.emitInitSegment = function(t) {
  ...
  for (var i = function(e) {
    var t = String(e).substr(2).toLowerCase();
    "av1" === t && (t = "av01.0.00M.08");
    return t;
  }, s = function(e, t) {
    switch (e) {
     case "A_VORBIS":
...
MediaSegment.prototype.append = function(e, t, i) {
  ...
  if (s > 0) {
    if ((r = e.readUInt16BE(s)) >> 8 === 191) {
      d && console.debug(this + " mkv timecode fixup (0x%s)", e.toString("hex", 0, s + 9));
      r = e.readUInt16BE(s += 6);
    }
    if (r >> 8 === 231 && (255 & r) > 127) {
...
},{"/bundle/utils":3,"buffer":8,"ebml/lib/ebml/decoder":9,"eventemitter3":13,"readable-stream":36}],5:[function(require,module,exports){
...
MP4Remuxer.prototype._findMoov = function(s) {
  var n = this, e = this._file, o = {
    moov: 1,
    sidx: 1
  }, i = "sidx";
  if (!(d > 11)) {
  ...
  if (e.filesize >= 0 && s >= e.filesize) return n._moov ? n._parseMoov() : n.emit("error", RangeError("Offset out of bound."));
  var a = e.createReadStream({
    start: s
  });
  n._decoder = mp4.decode();
  a.pipe(n._decoder);
  var f = 0, m = function(t) {
    var e = function() {
      a.destroy();
      n._decoder.removeListener("box", m);
      n._decoder.destroy();
    }, r = function() {
      if (n["_" + i]) {
        e();
        n._parseMoov();
      } else if (t.length < FIND_MOOV_SEEK_SIZE) {
        f += t.length;
        n._decoder.ignore();
      } else {
        e();
        n._findMoov(s + (f += t.length));
      }
    };
    d && console.debug("box", t.type, t.length, t, s);
    o[t.type] ? n._decoder.decode(function(e) {
      n["_" + t.type] = e;
      r();
    }) : r();
  };
...
MP4Remuxer.prototype._processMoov = function(e) {
  ...
  if (e.otherBoxes) for (var o = e.otherBoxes.length; o--; ) if (e.otherBoxes[o] instanceof Error) {
    t.emit("error", e.otherBoxes[o]);
    return;
  }
  t._tracks = [];
  t._hasVideo = !1;
  ...
  for (var i = 0; i < n.length; i++) {
    var a, f, m = n[i], c = m.mdia.minf.stbl, u = c.stco || c.co64, l = c.stsd.entries[0], p = m.mdia.hdlr.handlerType;
    d && console.debug("handler=%s, type=%s, trak:", p, l.type, m);
    if (!t._hasVideo && "vide" === p && s[l.type]) {
      a = l.type;
      l.avcC ? a += "." + l.avcC.mimeCodec : l.av1C && (a = l.av1C.mimeCodec || a);
      f = 'video/mp4; codecs="' + a + '"';
      d && console.debug(f);
      t._hasVideo = a;
    } else {
      if (t._hasAudio || "soun" !== p) continue;
      if ("mp4a" === l.type) {
        a = "mp4a";
        l.esds && l.esds.mimeCodec && (a += "." + l.esds.mimeCodec);
        r[a] && (a = "mp3");
      } else a = "fLaC" === l.type ? "flac" : l.type;
      f = (f = 'audio/mp4; codecs="%"').replace("%", a);
      d && console.debug(f);
      if (!MediaSource.isTypeSupported(f) && ("mp3" !== a || !MediaSource.isTypeSupported(f = "audio/mpeg"))) {
        t._hasUnsupportedAudio = a;
        continue;
      }
      t._hasAudio = a;
    }
    var h, v = [], _ = 0, x = 0, g = 0, y = 0, b = 0, S = 0, M = new RunLengthIndex(c.stts.entries), k = null;
    c.ctts && (k = new RunLengthIndex(c.ctts.entries));
    var B = 0;
    if (M.value) {
      while (1) {
        h = c.stsc.entries[b];
        var I = c.stsz.entries[_], E = M.value && M.value.duration || 0, R = !0;
        c.stss && (R = c.stss.entries[B] === _ + 1);
        v.push({
          size: I,
          duration: E,
          dts: S,
        ...
        if (++_ >= c.stsz.entries.length) break;
        y += I;
        if (++x >= h.samplesPerChunk) {
          y = x = 0;
          g++;
          var O = c.stsc.entries[b + 1];
          O && g + 1 >= O.firstChunk && b++;
        }
        S += E;
        M.inc();
        k && k.inc();
      ...
      m.mdia.mdhd.duration = 0;
      m.tkhd.duration = 0;
      var w = h && h.sampleDescriptionId || 0, C = {
        type: "moov",
        mvhd: e.mvhd,
        traks: [ {
          tkhd: m.tkhd,
          mdia: {
            ...
            elng: m.mdia.elng,
            minf: {
              vmhd: m.mdia.minf.vmhd,
              smhd: m.mdia.minf.smhd,
              dinf: m.mdia.minf.dinf,
              stbl: {
                stsd: c.stsd,
                stts: empty(),
                ctts: empty(),
      ...
      t._tracks.push({
        fragmentSequence: 1,
        trackId: m.tkhd.trackId,
        timeScale: m.mdia.mdhd.timeScale,
        samples: v,
        currSample: null,
        currTime: null,
        moov: C,
    ...
    } else console.warn("No 'stts' entries for trak %s...", i, m);
  }
...
MP4Remuxer.prototype._writeFragment = function(r, e) {
  var s = this, t = s._tracks[e], n = t.inStream, o = t.outStream, i = function(t) {
    return function(e) {
      e ? s.emit("error", e) : o.destroyed || n.destroyed ? d > 1 && console.debug("writeFragment stream destroyed", o.destroyed, n.destroyed) : t();
    };
  }, a = i(function() {
    if (!(r = s._generateFragment(e))) return o.finalize();
    m();
  }), f = i(function() {
    var e = n.slice(r.ranges), t = o.mediaData(r.length, a);
    e.pipe(t);
  }), m = function() {
    o.destroyed || o.box(r.moof, f);
  };
  m();
};
...
MP4Remuxer.prototype.seek = function(s) {
  ...
  if (d) {
    console.debug("MP4Remuxer: Measured highWaterMark to need %s bytes.", o);
    o > 1e7 && console.warn("^ excessive highWaterMark detected...");
  }
  o = o + 16777216 & -16777216;
...
MP4Remuxer.prototype._findSampleBefore = function(e, t) {
  ...
  if (n < 1) return 0;
  var o = n;
  while (!r.samples[n].sync) if (--n < 0) return o;
  return n;
};
...
MP4Remuxer.prototype._generateFragment = function(e, t) {
  ...
  for (var n = s.samples[r].dts, o = 0, i = [], a = r; a < s.samples.length; a++) {
    var d = s.samples[a];
  ...
  return {
    moof: this._generateMoof(e, r, s.currSample = a),
    ranges: i,
    length: o
  };
};
...
MP4Remuxer.prototype._generateMoof = function(e, t, r) {
  for (var s = this._tracks[e], n = [], o = 0, i = t; i < r; i++) {
    var a = s.samples[i];
    a.presentationOffset < 0 && (o = 1);
    n.push({
...
Box.boxes.co64.decode = function(e, t) {
  for (var r = (e = e.slice(t)).readUInt32BE(0), s = new Array(r), n = 0; n < r; n++) {
    var o = 8 * n + 4, i = e.readUInt32BE(o), a = e.readUInt32BE(4 + o);
    s[n] = i * UINT32_MAX + a;
  }
  return {
    entries: s
...
Box.boxes.av1C.encode = function _(e, t, r) {
  t = t ? t.slice(r) : Buffer.allocUnsafe(e.buffer.length);
  e.buffer.copy(t);
  _.bytes = e.buffer.length;
};

Box.boxes.av1C.decode = function(e, t, r) {
  var s = 0, n = Object.create(null), o = function() {
    return e.readUInt8(s++);
  };
  e = e.slice(t, r);
  var i = o();
  this.version = 127 & i;
  if (i >> 7 & !1) console.warn("Invalid av1C marker."); else if (1 !== this.version) console.warn("Unsupported av1C version %d.", this.version); else {
    i = o();
    n.seq_profile = i >> 5 & 7;
    n.seq_level_idx_0 = 31 & i;
    i = o();
    n.seq_tier_0 = i >> 7 & 1;
    n.high_bitdepth = i >> 6 & 1;
    n.twelve_bit = i >> 5 & 1;
    n.monochrome = i >> 4 & 1;
    n.chroma_subsampling_x = i >> 3 & 1;
    n.chroma_subsampling_y = i >> 2 & 1;
    n.chroma_sample_position = 3 & i;
    i = o();
    n.reserved = i >> 5 & 7;
    n.buffer = Buffer.from(e);
    (i = n.high_bitdepth) < 10 && (i = 8);
    n.mimeCodec = [ "av01", n.seq_profile, ("0" + n.seq_level_idx_0).slice(-2) + (n.seq_tier_0 ? "H" : "M"), ("0" + i).slice(-2) ].join(".");
  }
  return n;
};

Box.boxes.av1C.encodingLength = function(e) {
...
Box.boxes.sidx.decode = function(t, e) {
  var r, s = Object.create(null), n = e + 4, o = function() {
...
},{"./schema.js":10,"./tools.js":11,"/bundle/utils":3,"buffer":8,"readable-stream":36}],10:[function(require,module,exports){
...
MediaElementWrapper.prototype.error = function(e) {
  ...
  try {
    window.URL.revokeObjectURL(r._elem.src);
  } catch (e) {}
};
...
MediaSourceStream.prototype._getBufferDuration = function() {
  for (var e = this._sourceBuffer.buffered, r = this._elem.currentTime, t = -1, o = 0; o < e.length; o++) {
    var a = e.start(o), n = e.end(o) + EPSILON;
    if (a > r) break;
    (t >= 0 || r <= n) && (t = n);
  }
  var u = t - r;
...
},{"/bundle/utils":3,"readable-stream":36,"to-arraybuffer":38}],16:[function(require,module,exports){
...
exports.stts.encode = function(e, t, r) {
  ...
  for (var o = 0; o < n.length; o++) {
    ...
    t.writeUInt32BE(n[o].duration || 0, 4 + i);
  }
...
exports.ctts.encode = function(e, t, r) {
  ...
  for (var o = 0; o < n.length; o++) {
    var i = 8 * o + 4;
    t.writeUInt32BE(n[o].count || 0, i);
    t.writeUInt32BE(n[o].compositionOffset || 0, 4 + i);
  }
...
exports.ctts.decode = function(e, t) {
  for (var r = (e = e.slice(t)).readUInt32BE(0), n = new Array(r), o = 0; o < r; o++) {
    ...
    n[o] = {
      count: e.readUInt32BE(i),
      compositionOffset: e.readInt32BE(4 + i)
    };
  }
  return {
    entries: n
...
exports.stsc.encode = function(e, t, r) {
  ...
  for (var o = 0; o < n.length; o++) {
    ...
    t.writeUInt32BE(n[o].samplesPerChunk || 0, 4 + i);
    t.writeUInt32BE(n[o].sampleDescriptionId || 0, 8 + i);
  }
...
exports.stsc.decode = function(e, t) {
  for (var r = (e = e.slice(t)).readUInt32BE(0), n = new Array(r), o = 0; o < r; o++) {
    ...
    n[o] = {
      ...
      samplesPerChunk: e.readUInt32BE(4 + i),
      sampleDescriptionId: e.readUInt32BE(8 + i)
    };
  }
  return {
    entries: n
...
exports.elst.encode = function(e, t, r) {
  ...
  for (var o = 0; o < n.length; o++) {
    ...
    t.writeUInt32BE(n[o].mediaTime || 0, 4 + i);
    writeFixed32(n[o].mediaRate || 0, t, 8 + i);
  }
...
exports.elst.decode = function(e, t) {
  for (var r = (e = e.slice(t)).readUInt32BE(0), n = new Array(r), o = 0; o < r; o++) {
    ...
    n[o] = {
      ...
      mediaTime: e.readInt32BE(4 + i),
      mediaRate: readFixed32(e, 8 + i)
    };
  }
  return {
    entries: n
...
},{"./descriptor":17,"./index":18,"buffer":8,"uint64be":39}],17:[function(require,module,exports){
...
},{"./boxes":16,"buffer":8,"uint64be":39}],19:[function(require,module,exports){
...
},{"/bundle/utils":3,"buffer":8,"mp4-box-encoding":18,"next-event":22,"readable-stream":36}],20:[function(require,module,exports){
...
},{"/bundle/utils":3,"buffer":8,"mp4-box-encoding":18,"readable-stream":36}],21:[function(require,module,exports){
...
},{"/bundle/utils":3,"readable-stream":36}],26:[function(require,module,exports){
"use strict";
...
},{"/bundle/utils":3}],27:[function(require,module,exports){
"use strict";
...
},{"./_stream_readable":29,"./_stream_writable":31,"/bundle/utils":3}],28:[function(require,module,exports){
"use strict";
...
},{"./_stream_transform":30,"/bundle/utils":3}],29:[function(require,module,exports){
"use strict";
...
var StringDecoder, createReadableStreamAsyncIterator, EE = require("eventemitter3").EventEmitter, EElistenerCount = function(e, t) {
...
},{"../errors":26,"./_stream_duplex":27,"./internal/streams/buffer_list":32,"./internal/streams/destroy":33,"./internal/streams/state":34,"./internal/streams/stream":35,"/bundle/utils":3,"buffer":8,"eventemitter3":13,"string_decoder/":37}],30:[function(require,module,exports){
"use strict";
...
},{"../errors":26,"./_stream_duplex":27,"/bundle/utils":3}],31:[function(require,module,exports){
"use strict";
...
},{"../errors":26,"./_stream_duplex":27,"./internal/streams/destroy":33,"./internal/streams/state":34,"./internal/streams/stream":35,"/bundle/utils":3,"buffer":8}],32:[function(require,module,exports){
"use strict";

var Buffer = require("buffer").Buffer;

function copyBuffer(t, e, h) {
  Buffer.prototype.copy.call(t, e, h);
}
...
module.exports = function() {
  ...
  t.join = function(t) {
    ...
    var e = this.head, h = "" + e.data;
    while (e = e.next) h += t + e.data;
    return h;
  };
  t.concat = function(t) {
    if (0 === this.length) return Buffer.alloc(0);
    var e = Buffer.allocUnsafe(t >>> 0), h = this.head, i = 0;
    while (h) {
      copyBuffer(h.data, e, i);
      i += h.data.length;
      h = h.next;
    }
    return e;
  };
  t.consume = function(t, e) {
    var h;
    if (t < this.head.data.length) {
      h = this.head.data.slice(0, t);
      this.head.data = this.head.data.slice(t);
    } else h = t === this.head.data.length ? this.shift() : e ? this._getString(t) : this._getBuffer(t);
    return h;
  };
  t.first = function() {
    return this.head.data;
  };
  t._getString = function(t) {
    var e = this.head, h = 1, i = e.data;
    t -= i.length;
    while (e = e.next) {
      var a = e.data, n = t > a.length ? a.length : t;
      i += n === a.length ? a : a.slice(0, t);
      if (0 === (t -= n)) {
        if (n === a.length) {
          ++h;
  ...
  t._getBuffer = function(t) {
    var e = Buffer.allocUnsafe(t), h = this.head, i = 1;
    h.data.copy(e);
    t -= h.data.length;
    while (h = h.next) {
      var a = h.data, n = t > a.length ? a.length : t;
      a.copy(e, e.length - t, 0, n);
      if (0 === (t -= n)) {
        if (n === a.length) {
          ++i;
          this.head = h.next ? h.next : this.tail = null;
        } else (this.head = h).data = a.slice(n);
        break;
      }
      ++i;
    }
...
function getHighWaterMark(r, e, t, a) {
  ...
  if (null == i) return r.objectMode ? 16 : 16384;
  if (!isFinite(i) || Math.floor(i) !== i || i < 0) throw new ERR_INVALID_OPT_VALUE(a ? t : "highWaterMark", i);
  return Math.floor(i);
}
...
},{"../../../errors":26}],35:[function(require,module,exports){
module.exports = require("eventemitter3").EventEmitter;
},{"eventemitter3":13}],36:[function(require,module,exports){
...
VideoStream.prototype._createMuxer = function() {
  ...
  i._muxer = {
    WebM: 1,
    Matroska: 1
  }[i._type] ? new EBMLRemuxer(i._file) : new MP4Remuxer(i._file);
...
VideoStream.prototype._tryPump = function(o) {
  ...
  if (o - a > .4 || 0 === a) {
    ...
    if (u._seekCoercion !== a) {
      ...
      this._tryPump(e.currentTime = u._seekCoercion = a);
      return;
    }
...
},{"./ebml-remuxer":4,"./mp4-remuxer":5,"mediasource":15,"pump":24,"to-arraybuffer":38}]},{},[2]);

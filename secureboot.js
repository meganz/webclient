...
else if (!b_u)
{
    ...
    var languages = {'en':['en','en-'],'es':['es','es-'],'fr':['fr','fr-'],'de':['de','de-'],'it':['it','it-'],'nl':['nl','nl-'],'pt':['pt'],'br':['pt-br'],'dk':['da'],'se':['sv'],'fi':['fi'],'pl':['pl'],'cz':['cz','cz-'],'sk':['sk','sk-'],'sl':['sl','sl-'],'hu':['hu','hu-'],'jp':['ja'],'cn':['zh','zh-cn'],'ct':['zh-hk','zh-sg','zh-tw'],'kr':['ko'],'ru':['ru','ru-mo'],'ar':['ar','ar-'],'he':['he'],'id':['id'],'ca':['ca','ca-'],'bs':['bs','bs-'],'sg':[],'tr':['tr','tr-'],'hr':['hr'],'ro':['ro','ro-'],'uk':['||'],'sr':['||'],'th':['||'],'lv':['||'],'fa':['||'],'ee':['et'],'ms':['ms'],'bg':['bg'],'tl':['en-ph'],'ka':['||'],'vi':['vn', 'vi']};
    ...
    var jsl2 =
    {
        ...
        'change_email_js': {f:'html/js/change_email.js', n: 'change_email_js', j:1},
        'change_email': {f:'html/change_email.html', n: 'change_email', j:0},
